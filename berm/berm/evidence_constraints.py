...
_NODE_DIRECTION_DEFAULTS: Mapping[str, str] = {
    ...
    "DEMAND_OPPORTUNITY": "STATE_CONDITIONED_BEHAVIOUR_AND_OPPORTUNITY_JOINTLY_SHAPE_ENCOUNTERS",
    "REPRODUCTIVE_OPPORTUNITY": "EXTERNAL_INPUTS_AND_PARTNER_RESPONSES_REMAIN_EXPLICIT_CONTEXT",
    "CAREGIVING_ALLOCATION": "TARGET_SPECIFIC_CARE_AMOUNT_AND_ALLOCATION_CAN_DIVERGE_FROM_REPRODUCTION",
