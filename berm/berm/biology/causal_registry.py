...
CAUSAL_NODES: tuple[CausalNode, ...] = (
    ...
    CausalNode(
        ...
        ("MALE_SPERM", "BARRIER_BTB", "BIOBEHAVIORAL_WEIGHTING"),
        "capacity_component",
        "requires_endpoint_calibration",
    ),
    CausalNode(
    ...
    CausalNode(
        "BIOBEHAVIORAL_WEIGHTING",
        "Population distribution of biologically constrained behavioural weighting",
        "civilization",
        ("biological behavioural weighting", "latent motivation state"),
