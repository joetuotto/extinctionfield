...
CAUSAL_NODES: tuple[CausalNode, ...] = (
    ...
    CausalNode(
        "RECEPTOR_STATE_MEMORY",
        "Receptor chemical-state memory and recovery",
        "mechanism",
        ("chemical integration", "receptor recovery", "receptor state memory"),
        ("A_VGCC_ROS", "B_RPM_CRY"),
        ("CIRCADIAN_COORDINATION", "HORMONE_TARGET_RESPONSE"),
        "organ_state_input",
        "structural_only",
    ),
    CausalNode(
        "CIRCADIAN_COORDINATION",
        "Tissue-specific circadian phase relationships and electrical timing",
        "mechanism",
        ("tissue phase network", "circadian coordination"),
        ("A_VGCC_ROS", "B_RPM_CRY", "MELATONIN_REDOX", "RECEPTOR_STATE_MEMORY"),
        ("HORMONE_TARGET_RESPONSE", "OVULATION_CLOCK"),
        "organ_state_input",
        "structural_only",
    ),
    CausalNode(
        "HORMONE_TARGET_RESPONSE",
        "Hormone signal, target readiness and phase-dependent response",
        "mechanism",
        ("hormone target timing", "CRY endocrine gating"),
        ("B_RPM_CRY", "HPA_HPG", "RECEPTOR_STATE_MEMORY", "CIRCADIAN_COORDINATION"),
        (
            "MALE_STEROIDOGENESIS", "OVULATION_CLOCK", "IMPLANTATION",
            "INDIVIDUAL_BEHAVIORAL_RESPONSE", "CAREGIVING_ALLOCATION",
        ),
        "organ_state_input",
        "structural_only",
    ),
    ...
    CausalNode(
        ...
        ("MALE_SPERM", "BARRIER_BTB", "INDIVIDUAL_BEHAVIORAL_RESPONSE"),
        "capacity_component",
        "requires_endpoint_calibration",
    ),
    CausalNode(
    ...
    CausalNode(
        ...
        "ecology",
        ("natural selection", "measured-field selection", "relative abundance"),
        ("ECOLOGICAL_ENCOUNTER",),
    ...
    CausalNode(
        "ECOLOGICAL_TRAIT_STATE",
        "Time-indexed heritable trait distribution under selection associated with measured physical field conditions",
        "ecology",
        ("evolutionary trait distribution", "heritable measured-field response"),
        ("ECOLOGICAL_SELECTION",),
        (),
        "cross_species_outcome",
    ...
    CausalNode(
        "INDIVIDUAL_BEHAVIORAL_RESPONSE",
        "State-conditioned individual behavioural response probability",
        "civilization",
        (
            "individual behavioural response",
            "P(Y given z,x)",
            "state-dependent preference expression",
        ),
        (
            "HPA_HPG", "MELATONIN_REDOX", "ANDROGEN_RECEPTOR_SIGNAL",
            "HORMONE_TARGET_RESPONSE",
        ),
        ("BIOBEHAVIORAL_WEIGHTING", "DEMAND_OPPORTUNITY"),
        "civilization_state",
        "requires_matched_measurement",
    ),
    CausalNode(
        "CAREGIVING_ALLOCATION",
        "Caregiving amount, recipient allocation and contact feedback",
        "civilization",
        ("caregiving allocation", "alloparental care", "care recipient distribution"),
        ("HORMONE_TARGET_RESPONSE",),
        (),
        "civilization_state",
        "requires_matched_measurement",
    ...
    CausalNode(
        ...
        "Population mixture of state-conditioned behavioural probabilities",
        "civilization",
        (
            "biological behavioural weighting",
            "latent motivation state",
            "forward individual-to-aggregate composition",
        ),
        ("INDIVIDUAL_BEHAVIORAL_RESPONSE",),
    ...
    CausalNode(
        "NARRATIVE_ATTRIBUTION",
        "Accessible narrative attribution of a partly latent behavioural state",
        "civilization",
        ("interpreter", "reported reason", "causal attribution"),
        ("BIOBEHAVIORAL_WEIGHTING",),
    ...
    CausalNode(
        "EPISTAPEGE_OBSERVABILITY_LOSS",
        "Epistapege: upstream biological state omitted from the explanatory data model",
        "civilization",
        ("Epistapege", "structural non-detection", "observability loss"),
        ("NARRATIVE_ATTRIBUTION",),
    ...
    CausalNode(
        "INSTITUTIONAL_MODEL_REUSE",
        "Institutional reuse of downstream reports as initiating explanatory variables",
        "civilization",
        ("theory reuse", "institutional model selection"),
        ("EPISTAPEGE_OBSERVABILITY_LOSS",),
        (),
        "civilization_state",
    ...
    CausalNode(
        ...
        "External and interaction-conditioned reproductive opportunities",
        "demography",
        ("external reproductive opportunity", "partner response and access"),
        (),
        ("DEMAND_OPPORTUNITY",),
        "external_context_input",
        "requires_external_measurement",
    ),
    CausalNode(
        "DEMAND_OPPORTUNITY",
        "Reproductively exposed encounters and attempts",
        "demography",
        ("demand/opportunity", "partnering and opportunity", "reproductive realization"),
        ("INDIVIDUAL_BEHAVIORAL_RESPONSE", "REPRODUCTIVE_OPPORTUNITY"),
        ("ASFR",),
        "conditional_demographic_state",
        "requires_matched_measurement",
    ),
    CausalNode(
        "TEMPO",
