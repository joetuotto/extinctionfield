...
CAUSAL_NODES: tuple[CausalNode, ...] = (
    ...
    CausalNode(
        ...
        (
            ...
            "RECEPTOR_STATE_MEMORY", "CIRCADIAN_COORDINATION", "HORMONE_TARGET_RESPONSE",
        ),
        "organ_state_input",
        "structural_only",
    ),
    ...
    CausalNode(
        ...
        ("MALE_STEROIDOGENESIS", "OVULATION_CLOCK", "IMPLANTATION", "HORMONE_TARGET_RESPONSE"),
        "organ_state_input",
        "structural_only",
    ),
    # The graph records feed-forward component dependencies. Receptor state,
    # redox and hormonal feedback are time-indexed inside the coordination
    # state model; adding a static back-edge here would misrepresent that
    # feedback as a cyclic causal DAG. These nodes add no fitted coefficient.
    CausalNode(
        "RECEPTOR_STATE_MEMORY",
    ...
    CausalNode(
        ...
        "reproductive",
        ("Leydig",),
        ("HPA_HPG", "MELATONIN_REDOX", "MICROBIOME_OT", "HORMONE_TARGET_RESPONSE"),
        ("MALE_SPERM",),
        "capacity_component",
        "requires_endpoint_calibration",
    ),
    ...
    CausalNode(
        ...
        "reproductive",
        ("pregnancy support",),
        ("HPA_HPG", "MELATONIN_REDOX", "BARRIER_PLACENTA", "OOCYTE_REDOX", "HORMONE_TARGET_RESPONSE"),
        ("COUPLE_FECUNDABILITY",),
        "capacity_component",
        "requires_endpoint_calibration",
    ),
