...
**Julkaisu:** commitit `03f82a5` (malli + data), `18296c3` (sivustosisältö + peilit + raportti), `4169412` (sivilisaatiosivut D1–D3/D5), `4904c7c` (loput r = 0,909 -maininnat), `8df746f` (kausaaliketjun gradienttisolmu). Tuotanto www.extinctionfield.com deployattu puhtaista HEAD-worktreistä (viimeisin dpl extinctionfield-kr3fyhh73, READY); build-portit (tsc, eslint --max-warnings=0, anchor index, rendered-HTML-tarkistus) vihreät; DOM-varmistus: etusivu r = 0,84 / 0,614 / 8 lukittua; patopoliteia manistinen 2007–, 2025: 0,614, Amish 0,955, 0 tyhjää, 0 raakaa tokenia (en/fi/ja); sentinel r = 0,842 + 7 lajin taulukko; /model 5 claim-ankkuria säilyvät. origin/main = 4169412 (rinnakkainen sessio työnsi); 4904c7c ja 8df746f ovat paikallisia committeja.
