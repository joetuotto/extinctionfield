...
- **2D:4D × politiikka: ei yhtään tutkimusta** kolmessa indeksissä (Europe PMC 73 osumaa, Crossref 0, OpenAlex 79 — yksikään ei koske poliittisia asenteita). Proksin validiteettia koskeva näyttö on ristiriitaista.
...
**Konsensusennuste:** patogeenit → kollektivismi/autoritarismi (makro, näyttö ristiriitaista); inho → sosiaalinen konservatismi (piirre, robusti); pandemia → rally, ei ideologiamuutosta.
