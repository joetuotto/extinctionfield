  ...
  en: {
    ...
    objections: [
      ...
      },
      {
        ...
        response: [
          ...
          "Three of these moderators predict study outcomes with statistical significance: species/priming (χ²=9.4, p=0.002 — animal studies find effects 92% of the time vs. 35% for human studies), duration (χ²=10.8, p=0.001 — chronic exposure positive 92% vs. acute 31%), and pulsation (χ²=3.9, p=0.048 — pulsed signals positive 88% vs. CW 48%). Weller et al. (2025) validated this pattern in 517 genotoxicity studies: real devices produced more effects than laboratory CW signals, duration was a critical factor, and 58% of DNA damage occurred below ICNIRP safety limits.",
          "In every null-result study where subgroup analysis was performed, a positive subgroup was found: Graham 1996 identified a 'low baseline melatonin' subgroup, Lustenberger 2015 reported 'striking inter-individual differences,' and Sousouri 2025 showed response only in T/C carriers. The null overall result masks real effects in susceptible subgroups.",
        ...
        boundary: "The four-moderator framework is BERM's synthesis (M-level), now with quantitative validation: three moderators reach statistical significance (p<0.05) and Weller 2025 (n=517 genotoxicity studies) independently confirms the pattern. Individual moderators have empirical support: season (Halgamuge 2015, E-level), genotype (Sousouri 2025, E-level), ELF priming (PMC4757866, E-level). The retrospective meta-moderator test (REPL-1) would elevate this from M-level to E-level.",
      },
    ],
    ...
    objections: [
      ...
      },
      {
        ...
        boundary: "Neljän moderaattorin kehys on BERM:n synteesi (M-taso), nyt kvantitatiivisella validoinnilla: kolme moderaattoria saavuttaa tilastollisen merkitsevyyden (p<0,05) ja Weller 2025 (n=517 genotoksisuustutkimusta) vahvistaa kuvion itsenäisesti. Yksittäisillä moderaattoreilla on empiiristä tukea: vuodenaika (Halgamuge 2015, E-taso), genotyyppi (Sousouri 2025, E-taso), ELF-priming (PMC4757866, E-taso). Retrospektiivinen metamoderaattoritesti (REPL-1) nostaisi tämän M-tasolta E-tasolle.",
      },
    ],
