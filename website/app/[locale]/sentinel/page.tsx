...
const COPY = {
  en: {
    ...
    nikePeakFieldText: "Tulos on yhteensopiva BERM:n huippukenttähypoteesin kanssa. Nike LOPAR/HIPAR -pääkeilat osoittivat ylöspäin; maanpintatason altistus tuli sivukeilapulsseista 1/r²-vaimennuksella. Sivukeilan huippukenttä 1 km:ssä: ~24,5 V/m yhden 1 µs:n pulssin aikana, kun aikakeskiarvoistettu RMS on vain 0,037 V/m (suhde 671:1). BERM-reitit A (VGIC, 45 %), B (CRY/RPM, 25 %) ja D (HPA, 15 %) ovat kynnys- tai pulssimekanismeja, jotka vastaavat huippukenttään, eivät aikakeskiarvoistettuun RMS:ään. Monotoninen 1/r²-gradientti on näiden reittien odotettu spatiaalinen profiili. CRY/RPM-radikaaliparin elinaika (~1 µs) vastaa tutkapulssin kestoa (~1 µs) — jokainen pulssi kattaa radikaaliparin koko singletti–tripletti-konversioikkunan, 400 kertaa sekunnissa.",
    nikeRichnessNote: "Lajirikkaus ja runsaus eroavat: lajirikkausgradientti säilyy osavaltion sisäisessä permutaatiossa (p = 0,006), mutta runsaustrendi heikkenee osavaltiotason sekoittajien kontrolloinnissa (p = 0,103). Tämä tarkoittaa, että tutkan läheisyys ennustaa luotettavammin mitä lajeja on läsnä kuin kuinka monta yksilöä selviää. Lintusignaali on detrendattu (hidas, rakenteellinen) — se ei näy ensimmäisen differenssin (nopea, vuosi-vuosi) analyysissä. Sama jako näkyy eurooppalaisessa paneelissa: 27 maan PECBMS-pesimälintuindeksissä (2002–2022) detrendattu indeksi edeltää TFR-laskua noin 2,5 vuodella (21/27 maata BERM-suunnassa, r = 0,182, p = 0,006), kun taas ensimmäisen differenssin sarjassa vastaavaa edeltävyyttä ei ole. Hidas rakenteellinen signaali löytyy, nopea pulssi ei.",
