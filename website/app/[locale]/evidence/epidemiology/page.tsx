    ...
    narratives: [
      ...
      },
      {
        ...
        studies: [
          ...
          { citation: "BERM v17.1 formula discovery", year: 2026, referenceId: "nations2024", note: "54 countries, LOOCV RMSE 0.522, R² 0.851" },
        ],
      },
      {
        id: "mobile-paradox",
        ...
        studies: [
          { citation: "BERM v17.1 cross-sectional analysis", year: 2026, referenceId: "nations2024", note: "Mobile RMSE 1.053 vs electricity RMSE 0.533 (54 countries)" },
    ...
    narratives: [
      ...
      },
      {
        ...
        studies: [
          ...
          { citation: "BERM v17.1 kaavanlöytö", year: 2026, referenceId: "nations2024", note: "54 maata, LOOCV RMSE 0,522, R² 0,851" },
        ],
      },
      {
        id: "mobile-paradox",
        ...
        studies: [
          { citation: "BERM v17.1 poikkileikkausanalyysi", year: 2026, referenceId: "nations2024", note: "Matkapuhelin RMSE 1,053 vs sähkö RMSE 0,533 (54 maata)" },
    ...
    narratives: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "これは勾配ではなく二値閾値である。教育、収入、避妊へのアクセスはすべて勾配である — 多いほど少ないのとは段階的に異なる。EMF曝露のみがインフラ境界に対応する物理的閾値を持つ。この構造的差異は検証可能な予測を生む：国の電力消費を電気にアクセスできる人口の割合で調整するとTFR予測が改善するはずである。実際にそうなる：相関はr = −0.864からr = −0.885に改善する（54か国、LOOCV RMSE 0.522）。",
        ...
        studies: [
          ...
          { citation: "BERM v17.1式発見", year: 2026, referenceId: "nations2024", note: "54か国、LOOCV RMSE 0.522、R² 0.851" },
        ],
      },
      {
        id: "mobile-paradox",
        title: "携帯電話のパラドックス",
        paragraphs: [
          "100人あたりの携帯電話契約数 — 直感的に最も直接的なEMFプロキシ — は54か国にわたるTFRの最も弱い単一予測因子である（RMSE 1.053、GDP単独の0.719より悪い）。住宅用電力消費は最良である（指数関数形式でRMSE 0.533）。",
        ...
        studies: [
          { citation: "BERM v17.1横断的分析", year: 2026, referenceId: "nations2024", note: "携帯電話RMSE 1.053 vs 電力RMSE 0.533（54か国）" },
    ...
    narratives: [
      ...
      },
      {
        ...
        studies: [
          ...
          { citation: "Decouverte de formule BERM v17.1", year: 2026, referenceId: "nations2024", note: "54 pays, LOOCV RMSE 0,522, R² 0,851" },
        ],
      },
      {
        id: "mobile-paradox",
        ...
        paragraphs: [
          "Les abonnements de telephonie mobile pour 100 personnes — intuitivement le proxy EMF le plus direct — est le predicteur unique le PLUS FAIBLE du TFR dans 54 pays (RMSE 1,053, pire que le PIB seul a 0,719). La consommation electrique residentielle est le MEILLEUR (RMSE 0,533 en forme exponentielle).",
        ...
        studies: [
          { citation: "Analyse transversale BERM v17.1", year: 2026, referenceId: "nations2024", note: "Mobile RMSE 1,053 vs electricite RMSE 0,533 (54 pays)" },
    ...
    narratives: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "이것은 기울기가 아니라 이진 역치이다. 교육, 소득, 피임 접근성은 모두 기울기이다 — 더 많은 것은 더 적은 것과 점진적으로 다르다. EMF 노출만이 인프라 경계에 대응하는 물리적 역치를 가진다. 이 구조적 차이는 검증 가능한 예측을 만든다: 국가 전력 소비를 접근 가능한 인구 비율로 조정하면 TFR 예측이 개선되어야 한다. 실제로 그렇다: 상관관계가 r = −0.864에서 r = −0.885로 개선된다(54개국, LOOCV RMSE 0.522).",
        ...
        studies: [
          ...
          { citation: "BERM v17.1 공식 발견", year: 2026, referenceId: "nations2024", note: "54개국, LOOCV RMSE 0.522, R² 0.851" },
        ],
      },
      {
        id: "mobile-paradox",
        title: "휴대전화 패러독스",
        paragraphs: [
          "100명당 휴대전화 가입 수 — 직관적으로 가장 직접적인 EMF 프록시 — 는 54개국에 걸친 TFR의 가장 약한 단일 예측 인자이다(RMSE 1.053, GDP 단독의 0.719보다 나쁨). 주거용 전력 소비가 가장 좋다(지수 형태에서 RMSE 0.533).",
        ...
        studies: [
          { citation: "BERM v17.1 횡단적 분석", year: 2026, referenceId: "nations2024", note: "휴대전화 RMSE 1.053 vs 전력 RMSE 0.533(54개국)" },
