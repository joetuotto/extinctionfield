...
const COPY = {
  en: {
    ...
    title: "Tautikaskadi: ionikanavakonvergenssi",
    subtitle: "Ioninen hoitohierarkia, ihoakku, ADHD ja kahdeksan sairauden konvergenssi",
    ...
    ihP1: "Retrodiktio R4 esittää, että masennus reagoi paremmin sähköön kuin kemiaan. Ioninen hoitohierarkia selittää, miksi: kaikki mielialahäiriöiden hoidot — SSRI:istä psykedeeleihin — konvergoivat lopulta kalsiumhomeostaasiin. Niiden tehokkuus seuraa ionisen kohdistuksen astetta.",
    ...
    ihEpistemic: "Episteeminen taso: litiumin ionimekanismi [E] ([[ref:elmallakh2004_lithium_ion|El-Mallakh/Bhansali]] data). Psykedeelien Ca²⁺/CACNA1C-konvergenssi [E] ([[ref:sousouri2025|Sousouri 2025]]). ECT:n CSD-mekanismi [E] ([[ref:rosenthal2025_ect_csd|Rosenthal 2025]]). Hierarkiaennuste [M|C] (Lindgren).",
    // Section 2: Skin Battery
    ...
    sbFinding6: "TRPV4 välittää Ca²⁺-influksia ja histaminergista kutinaa keratinosyyteissä",
    sbEpistemic: "Episteeminen taso: TEP ja haavan sähkökenttä [E] ([[ref:lim2024_skin_battery|Lim]]/[[ref:zhao2006_wound_ef|Zhao]]). Pietsosähköinen kollageeni [E] ([[ref:fukada1957_piezo|Fukada/Yasuda]]). VGCC-konvergenssi [E] ([[ref:pall2013_v2|Pall/PMC5828134]]). EHS-selitys [M|C] (malli).",
    // Section 3: ADHD
    ...
    adhdFinding3: "Timothy-syndrooman CACNA1C gain-of-function → aksonikohdennus ja käyttäytyminen muuttuvat",
    ...
    // Section 4: Ion Convergence
    icHeading: "Ionikanavakonvergenssi: kahdeksan sairautta, yksi malli",
    ...
    icEpistemic: "Episteeminen taso: Ionikanavien rooli jokaisessa sairaudessa [E] (GWAS, farmakologia, FDA). EMF → ionikanava -mekanismi [E] ([[ref:pall2013_v2|Pall 2013]]). EMF → sairauskausaatio [C] (hypoteesi). Konvergenssimalli on TEOREETTINEN KEHYS — se ei todista kausaatiota. Jokainen sairaus on monitekijäinen. Se, että ionikanavalääke toimii, todistaa ionikanavien roolin OIREISSA mutta ei välttämättä SYYSSÄ.",
    // Section 5: See Also
    seeAlso: "Katso myös",
    evidenceRegister: "Evidenssirekisteri",
    evidenceRegisterDesc: "Koko BERM v17 -evidenssirekisteri",
