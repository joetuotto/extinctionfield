...
const COPY = {
  en: {
    ...
    title: "Reproduktiivinen navigointi",
    subtitle: "Siittiöt ovat BERM:n spesifisin biologinen argumentti. Yhdeksän kalsiumriippuvaista vaihetta tuotannosta hedelmöitykseen — jokainen EMF-haavoittuva, ilman varakanavaa.",
    ...
    s1Points: [
      ...
      },
      {
        ...
        mechanism: "Lisäkiveksessä siittiöt ovat IMMOBIILEJA (matala pH → CatSper INAKTIIVINEN). EMF → ennenaikainen CatSper-aktivaatio → Ca²⁺↑ → hyperaktivaatio ENNEN ejkulaatiota → rajallisten energiavarastojen ehtyminen → siittiöstä tulee immotiili naisen elimistössä.",
      ...
      },
      {
        ...
        pharmacological: "NAC + C-vitamiini → osittainen suoja. Antioksidantit toimivat mutta EIVÄT estä Ca²⁺-influksia → EIVÄT suojaa navigointia.",
      ...
      },
      {
        ...
        recovery: "Ei sovellettavissa — jos CatSper häiriintyy ennen ejkulaatiota, reotaktinen ohjaus epäonnistuu.",
      },
      {
        id: "chemotaxis",
      ...
      },
      {
        ...
        mechanism: "ZP3/ZP4 → jänniteriippuvainen Ca²⁺-influksi (VOC + SOC) → akrosomi avautuu → entsyymit vapautuvat → ZP:n läpäisy mahdollinen. Liian aikainen TAI liian myöhäinen = epäonnistuminen.",
        evidence: "ZP indusoi jänniteriippuvaisen Ca²⁺-influksin ja akrosoemireaktion ([[ref:bmc2006_zp|Patrat 2006]]). Keramidi-1-fosfaatti → Ca²⁺ VOC/SOC:n kautta ([[ref:pmc10102357_ceram|Rehfeld et al. 2023]]). NNC55-0396 → progesterooni-indusoima AR KUMOTTU ([[ref:pmc6104424_nnc|Rennhack et al. 2018]]).",
      ...
      },
      {
        ...
        mechanism: "Siittiön PLCζ → IP3 → ER Ca²⁺ -vapautuminen → Ca²⁺-oskillaatiot. Oskillaatiokuvio (taajuus, amplitudi, kesto) ON INFORMAATIOTA → oikea kuvio → meioosi II; väärä kuvio → epäonnistuminen.",
    ...
    s2Lead: "CatSper on siittiöspesifinen kalsiumkanava. Mikään muu ionikanava ei voi korvata sitä — knockout = steriili.",
    s2Points: [
      "Siittiöspesifinen: ilmentyy VAIN siittiön flagellumissa, ei missään muualla kehossa",
    ...
    s3Desc: "Lisäkiveksessä siittiöt ovat lepotilassa (matala pH pitää CatSper:n inaktiivisena). Puhelin taskussa -EMF voi ennenaikaisesti aktivoida CatSper:n, laukaisten hyperaktivaation ennen ejkulaatiota. Siittiö kuluttaa rajalliset energiavarastonsa vielä varastoinnissa. Ejkulaation jälkeen se saapuu naisen elimistöön morfologisesti normaalina mutta kykenemättömänä navigoimaan.",
    ...
    s4Gates: [
      ...
      { label: "Portti 4: Munasolun aktivaatio", process: "PLCζ → IP3 → Ca²⁺-oskillaatiot", emfDisruption: "Poikkeava oskillaatiokuvio → aktivaation epäonnistuminen" },
    ...
    s5Drugs: [
      ...
      { name: "RU1968", action: "CatSper-spesifinen inhibiittori → virran vähennys", ref: "" },
    ],
    ...
    s6Points: [
      ...
      { label: "Äärimmäinen valintapaine", detail: "~200 miljoonaa → 1 = 99,99999 % hylkäysaste. Pienikin suorituskyvyn lasku eliminoi miljoonia lisää" },
