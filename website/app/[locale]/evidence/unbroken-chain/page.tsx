...
const COPY = {
  en: {
    ...
    cautionText:
      "Tämä sivu esittää systemaattisen todentamisen BERM:n mekanistisesta ketjusta fyysisten skaalojen yli. Jokainen linkki on testattu julkaistua kokeellista näyttöä vasten. Ketju on yhtä vahva kuin heikoin linkki — osittaiset vahvistukset ja testaamattomat ennusteet on merkitty nimenomaisesti.",
