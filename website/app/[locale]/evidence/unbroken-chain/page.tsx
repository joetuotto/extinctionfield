...
const COPY = {
  en: {
    ...
    chainRows: [
      ...
      { scale: "10⁻⁶ m", link: "VK51: CatSper = sperm-specific Ca²⁺ channel (5 infertility routes)", evidence: "RBMO 2014: knockout = sterile; Nature Comms 2025: temp-gated Q₁₀=5.1; JCI 2024: human mutations", status: "confirmed", detail: "Young 2024 identifies human CatSper deficiency as a functional hyperactivation/fertilization defect despite potentially normal routine semen parameters. Calcium clearance and the later oocyte PLCζ signal are separate mechanisms. Hormonal, DNA, tissue and channel changes may share causes and must not be multiplied as five independent effects." },
