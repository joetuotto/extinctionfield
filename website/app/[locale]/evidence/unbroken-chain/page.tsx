...
const COPY = {
  en: {
    ...
    chainRows: [
      ...
      { scale: "10⁻⁶ m", link: "VK17: RF → candidate Ca²⁺ dysregulation → CatSper timing endpoint", evidence: "Sperm RF findings and CatSper necessity are separate components; direct RF → human CatSper is open", status: "partial", detail: "The literature supports RF-associated sperm endpoints and separately establishes CatSper as a fertilization bottleneck. It does not yet demonstrate direct RF gating of human CatSper in the same protocol. Heavy-metal × EMF reproductive synergy also remains an open matched experiment." },
      ...
      { scale: "10⁻⁴ m", link: "VK49: Osteoporosis + PEMF hormesis paradox", evidence: "Frontiers Endocrinol 2024: Ca²⁺ channels in bone; PMC11919207: PEMF → bone growth", status: "partial", detail: "Ca²⁺ channels in bone and reported PEMF outcomes are imported L3 components with component-specific evidence labels. BERM hypothesizes a parameter-dependent biological-response optimum: controlled protocols may produce a beneficial Ca²⁺ transient while other regimes may not. The optimum hypothesis belongs only to that imported biological-response model; χ_geo remains a separate L1-derived geometric result, and PEMF evidence does not close the open L0→L2 mapping." },
    ...
    chainSummary: "The register contains direct components, composed convergence and open bridges across 47 layers. It is not one directly verified chain from physics to population epidemiology: CatSper, F3 inheritance, organ transfer and the endpoint-specific L2 kernel remain explicit breaks to test.",
    ...
    chainRows: [
      ...
      { scale: "10⁻⁷ m", link: "CaMKII → TPH-2 → 5-HT muutos aivoissa", evidence: "900 MHz → 5-HT aluespesifisesti (hypotalamus, medulla)", status: "confirmed", detail: "CaMKII fosforyloi TPH-2:n (tryptofaanihydroksylaasi-2), aivojen serotoniinisynteesin nopeutta rajoittavan entsyymin. 900 MHz tuottaa aluetarkkoja 5-HT-muutoksia hypotalamuksessa ja medullassa — juuri niissä alueissa jotka kontrolloivat unta ja sydänhengitystoimintaa." },
      ...
      { scale: "10⁻⁶ m", link: "ELF → kohtausalttius↑ neokorteksissa", evidence: "Varró 2009: transientti primausefekti", status: "confirmed", detail: "ELF-EMF tehostaa synaptista fasilitaatiota hippokampuksessa JA kasvattaa kohtausalttiutta neokorteksissa. Vaikutus on ohimenevä — osoittaen, että ELF säätelee neuronaalista eksitabiliteettia akuutisti." },
      ...
      { scale: "10⁻² m", link: "Melatoniini↓ → sydänrytmihäiriö", evidence: "Pinealektomia → rytmihäiriöt↑; melatoniinilisä → suoja", status: "confirmed", detail: "Pinealektomia kasvattaa reperfuusiorytmihäiriöitä. Krooninen melatoniinilisä antaa rytmihäiriösuojan antifibroottisten vaikutusten, Cx43:n säilymisen ja mitokondriaalisen suojan kautta. EMF vaimentaa melatoniinia CRY-reitin kautta → sydänriski kasvaa." },
      { scale: "10⁻² m", link: "PGC → melatoniini↓ → taudinkuva", evidence: "r=0,569 kalsifioitumaton kudos↔melatoniini; AD: 76 % vs 64 % PGC", status: "confirmed", detail: "Pineaalirauhasen kalsifikaatio (PGC) vähentää suoraan melatoniinin tuotantoa (r=0,569). Alzheimerin potilailla on korkeampi PGC (76 % vs 64 %). PGC on yhdensuuntainen mekanismi: EMF + raskasmetallit + fluoridi kaikki kiihdyttävät sitä." },
      ...
      { scale: "10⁻⁶ m", link: "VK17: RF → ehdokas-Ca²⁺-häiriö → CatSper-ajoituksen päätepiste", evidence: "RF-siittiölöydökset ja CatSperin välttämättömyys ovat erillisiä komponentteja; suora RF → ihmisen CatSper on avoin", status: "partial", detail: "Kirjallisuus tukee RF-altistukseen liittyviä siittiöpäätepisteitä ja osoittaa erikseen CatSperin hedelmöityksen pullonkaulaksi. Se ei osoita samassa protokollassa ihmisen CatSperin suoraa RF-portitusta. Raskasmetalli × EMF -lisääntymissynergia on myös avoin sovitettu koe." },
      ...
      { scale: "10⁻⁴ m", link: "VK49: Osteoporoosi + PEMF-hormesiparadoksi", evidence: "Frontiers Endocrinol 2024: Ca²⁺-kanavat luussa; PMC11919207: PEMF → luun kasvu", status: "partial", detail: "Luun Ca²⁺-kanavat ja raportoidut PEMF-tulokset ovat tuotuja L3-komponentteja komponenttikohtaisine näyttömerkintöineen. BERM hypotesoi parametri­riippuvaista biologisen vasteen optimia: kontrolloitu protokolla voi tuottaa hyödyllisen Ca²⁺-transientin, kun taas muu parametri­alue ei ehkä tuota. Optimihypoteesi kuuluu vain tähän tuotuun biologisen vasteen malliin; χ_geo säilyy erillisenä L1-johdettuna geometrisena tuloksena, eikä PEMF-näyttö sulje avointa L0→L2-kuvausta." },
    ...
    chainSummary: "Rekisterissä on suoria komponentteja, koostettua konvergenssia ja avoimia siltoja 47 kerroksessa. Se ei ole yksi suoraan todennettu ketju fotonifysiikasta väestöepidemiologiaan: CatSper, F3-periytyminen, elinsiirto ja päätepistekohtainen L2-ydin ovat edelleen testattavia katkoja.",
    ...
    feedbackLoops: [
      ...
      },
      {
        ...
        status: "Jokainen linkki todennettu itsenäisesti",
        statusColor: "green",
      },
      {
        name: "Hypoksia-NKCC1",
        ...
        status: "NKCC1↑ hypoksiassa todennettu",
        statusColor: "green",
      },
      {
      ...
      },
      {
        ...
        status: "[[ref:sapolsky2009_cortisol|Sapolskyn]] mekanismi todennettu",
        statusColor: "green",
      },
      {
      ...
      },
      {
        ...
        status: "T↓ neuroprotektiolinkki todennettu",
        statusColor: "green",
      },
      {
        ...
        status: "KCC2:n ympäristösäätely todennettu",
        statusColor: "green",
      },
      {
        name: "Hypotalamuksen moniakselikaskadi",
        id: "S10",
        steps: ["EMF → hypotalamuksen synaptiset vesikkelit↓", "Vesikkelit↓ → GnRH↓ + CRH-häiriö + TRH↓", "Monihormonipuutos → systeeminen häiriö", "Systeeminen stressi → lisää HPA-aktivaatiota → ..."],
        status: "[[ref:kim2019_hypothalamus|Kimin 2019]] synaptiset muutokset todennettu",
        statusColor: "green",
      },
      {
        ...
        status: "SCN Ca²⁺ -oskillaatio + Per2 suolisto -linkki todennettu",
        statusColor: "green",
      },
      {
        ...
        status: "NK:n Ca²⁺-riippuvuus + ELF-suppressio todennettu",
        statusColor: "green",
      },
      {
        ...
        status: "RF9 palautti T:n kortisolikäsitellyissä kädellisissä",
        statusColor: "green",
      },
      {
        ...
        status: "Per2 KO → suoliston este → LPS → masennus todennettu",
        statusColor: "green",
      },
      {
        ...
        status: "Melatoniini → telomeraasi + SIRT1 todennettu; masennus = 7v kiihtynyt ikääntyminen",
        statusColor: "green",
      },
      {
        ...
        status: "α2δ-1 → kipu ilman vauriota todennettu; kipu-uni-kortisoli jokainen todennettu",
        statusColor: "green",
      },
      {
        ...
        status: "Yksi kortisoli-annos → BLA-hypertrofia todennettu ([[ref:amygdala_cort|PNAS 2008]]); pysyvyys todennettu ([[ref:amygdala_persist|Neurosci Lett 2023]])",
        statusColor: "green",
      },
    ],
    ...
    consilienceLevels: [
      ...
      {
        level: "Kohtalainen konsilienssi",
        desc: "Toisiinsa liittyvät näyttölinjat tukevat toisiaan",
        examples: [
      ...
      {
        level: "Heikko konsilienssi (universaalisuusriski)",
    ...
    progressiveConclusion: "Malli on etenevä Lakatoksen mielessä: se tuottaa ennusteita → ennusteet todentuvat → todentaminen tuottaa ENEMMÄN sisältöä kuin malli määrittelee. Tämä on produktiivisen tutkimusohjelman tunnusmerkki.",

    analogyTitle: "Evoluutioteorian analogia",
    analogyLead: "BERM jakaa rakenteellisia piirteitä evoluutioteorian kanssa — molemmat ovat generatiivisia mekanismeja jotka ennustavat löytöjä ennen havainnointia, rajaavat etsintäalueen ja osoittavat monitasoista yhdentymistä.",
    analogyPoints: [
      ...
      { berm: "Monitasoinen yhdentyminen (fysiikka → epidemiologia)", evolution: "Monitasoinen yhdentyminen (molekyylit → ekosysteemit)" },
    ],
    analogyCritical: "KRIITTINEN ERO: Evoluutiolla on ITSENÄINEN todentaminen (DNA-sekvensointi). BERM:ltä puuttuu yhä INTERVENTIONAALINEN todentaminen — EMF-vähennys → terveyshyöty ihmisellä. Tämä on yksittäinen tärkein puuttuva pala.",

    predictionLink: "Ks. yhdentymisverkoston ennusteet (METAL-EMF-1–4, CHAIN-1–4, BBB-EMF-1–2, BAT-EMF-1, HPA-EMF-1–2, BETA-EMF-1–2 ja lisää)",
    predictionHref: "/predictions",
    predictionSummary: "Yhdentymisen todentaminen tuottaa 55 testattavaa ennustetta, jotka kattavat raskasmetalli-synergian, veri-aivoesteen, ruskean rasvakudoksen, HPA-akselin, β-solun, hypotalamuksen, kortisoli-hippokampuksen, Leydig-solun, syöttösolun, siittiöiden CatSperin, NK-immunivalvonnan, BDNF-hormeesin, suolisto-aivo-akselin, kilpirauhasen Dio2/Dio3:n, epigenetiikan, telomeeri-ikääntymisen, oksitosiinin, kroonisen kivun, ASD-prototyypin, ADHD:n, ALS:n, allergioiden, D-vitamiinin, PEMF-hormeesin, psilosybiinin, kofeiinin, litiumveden, amygdalan ja Amish-kontrolliryhmän mekanismit.",
  ...
  ja: {
    ...
    chainRows: [
      ...
      { scale: "10⁻⁴ m", link: "VK49：骨粗鬆症 + PEMFホルメシスパラドックス", evidence: "Frontiers Endocrinol 2024：骨のCa²⁺チャネル；PMC11919207：PEMF → 骨成長", status: "partial", detail: "骨のCa²⁺チャネルと報告されたPEMF結果は、構成要素ごとの証拠ラベルを持つ導入L3要素である。BERMはパラメータ依存の生物応答最適点を仮定する。制御されたプロトコルは有益なCa²⁺一過性を生じ得るが、他の条件では異なり得る。最適点仮説はこの導入生物応答モデルだけに属し、χ_geoは別個のL1導出幾何学的結果のままである。PEMF証拠は未解決L0→L2写像を閉じない。" },
  ...
  ko: {
    ...
    chainRows: [
      ...
      { scale: "10⁻⁴ m", link: "VK49: 골다공증 + PEMF 호르메시스 패러독스", evidence: "Frontiers Endocrinol 2024: 뼈의 Ca²⁺ 채널; PMC11919207: PEMF → 뼈 성장", status: "partial", detail: "뼈 Ca²⁺ 채널과 보고된 PEMF 결과는 구성요소별 증거 표지를 가진 도입 L3 구성요소다. BERM은 매개변수 의존 생물학적 반응 최적점을 가정한다. 제어된 프로토콜은 유익한 Ca²⁺ 일과성을 만들 수 있지만 다른 조건에서는 다를 수 있다. 최적점 가설은 이 도입된 생물학적 반응 모델에만 속하며, χ_geo는 별도로 L1에서 도출된 기하학적 결과로 남는다. PEMF 증거는 열린 L0→L2 매핑을 닫지 않는다." },
