...
const COPY = {
  en: {
    ...
    epistemicText: "Tämä sivu esittää testattavan hypoteesin (L*-taso). Yksittäiset biokemialliset mekanismit ovat kokeellisesti vahvistettuja (E-taso): FAD stabiloi CRY:tä ([[ref:hirano2017|Hirano 2017]]), FAD vaaditaan magneettiseen herkkyyteen ([[ref:yap2025|Yap 2025]]), AMPK hajottaa CRY1:n ([[ref:lamia2009|Lamia 2009]]), CRY:n orientaatio riippuu kalvokoostumuksesta ([[ref:majewska2025|Majewska 2025]]). Synteesi — että ravitsemustila systemaattisesti säätelee polku C:n tehokkuutta väestötasolla — ei ole suoraan testattu. Kiinan B2-korrelaatio on ekologinen, ei kausaalinen.",
    seeAlso: "Katso myös",
