    ...
    narratives: [
      {
        ...
        paragraphs: [
          ...
          "BERMとの関連：これは、BERMの主要経路（C_RPM）の生物学的基盤がヒトに存在し機能することを確立する。それ以前のCRY/RPM証拠はDrosophila（[[ref:yoshii2009|Yoshii 2009]]）、鳥類（[[ref:ritz2004|Ritz 2004]]、[[ref:engels2014|Engels 2014]]）、プラナリア（[[ref:pnasnexus2026|PNAS Nexus 2026]]）、in vitroヒト細胞系（[[ref:sherrard2018|Sherrard 2018]]）に限られていた。[[ref:chae2019|Chae 2019]]は、ヒトCRY系がRPMを介して地磁気に応答するという必要条件を示すが、この応答のRF妨害は検証していない（判別テストD1〜D3を待つ）。",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "これはBERM経路C（EMF → 松果体melatonin抑制 → GnRH拍動障害 → HPG → 性腺機能）を直接支持する。20–50%の抑制は生物学的に有意で、EMFを夜間の三重打撃（melanopsin + CRY + melatonin抑制）の一要素とするBERMのv17_night_fraction()関数と一致する。光誘発性（>90%）より小さいことも、EMFを唯一の駆動因子ではなく複数の夜間撹乱経路の一つとするBERMと一致する。方法論的注記：高い基準を満たした研究は27%のみで、動物研究の48%は適切なsham対照を欠いた。細胞作用から全身的概日撹乱への移行は臨床的に完全には確立していない。",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "関連項目：眼の色と磁気受容——虹彩色素、栄養、性別がCRY感受性をどう調節するか。青い眼は茶色の眼より網膜cryptochromeへ約100倍多く光を通す（[[ref:higuchi2007|Higuchi 2007]]：melatonin抑制89%対73%）。ビタミンB2由来FADの利用可能性はCRY安定性と磁場方向選択性を直接制御する（[[ref:hirano2017|Hirano 2017]]、[[ref:yap2025|Yap/Sherrard 2025]]）。これらの調節因子は経路Cの有効性における個人間・集団間分散の一部を説明し得る。",
        ],
        studies: [
    ...
    narratives: [
      {
        ...
        paragraphs: [
          ...
          "Pertinence BERM : cela établit que le substrat biologique de la voie principale de BERM (C_RPM) existe et fonctionne chez l'humain. Les preuves CRY/RPM antérieures se limitaient à la Drosophile ([[ref:yoshii2009|Yoshii 2009]]), aux oiseaux ([[ref:ritz2004|Ritz 2004]], [[ref:engels2014|Engels 2014]]), aux planaires ([[ref:pnasnexus2026|PNAS Nexus 2026]]) et aux systèmes cellulaires humains in vitro ([[ref:sherrard2018|Sherrard 2018]]). [[ref:chae2019|Chae 2019]] démontre la condition nécessaire — que le système CRY humain répond au champ géomagnétique via le RPM — mais ne teste pas la perturbation RF de cette réponse, qui attend les tests discriminants D1–D3.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Cela soutient directement la voie C de BERM (EMF → suppression de mélatonine pinéale → perturbation de la pulsatilité GnRH → HPG → fonction gonadique). L'ampleur de 20–50 % est biologiquement significative et cohérente avec v17_night_fraction(), où l'EMF est une composante du triple impact nocturne (mélanopsine + CRY + suppression de mélatonine). Une suppression inférieure à celle de la lumière est cohérente avec plusieurs voies nocturnes plutôt qu'un seul moteur. Note méthodologique : 27 % seulement satisfaisaient les critères élevés et 48 % des études animales manquaient de sham adéquat. Le passage des effets cellulaires à la perturbation circadienne systémique n'est pas entièrement établi cliniquement.",
    ...
    narratives: [
      {
        ...
        paragraphs: [
          ...
          "BERM 관련성: 이는 BERM의 주요 경로(C_RPM)의 생물학적 기반이 인간에게 존재하고 기능함을 확립한다. 이전 CRY/RPM 증거는 Drosophila([[ref:yoshii2009|Yoshii 2009]]), 조류([[ref:ritz2004|Ritz 2004]], [[ref:engels2014|Engels 2014]]), 플라나리아([[ref:pnasnexus2026|PNAS Nexus 2026]]), in vitro 인간 세포계([[ref:sherrard2018|Sherrard 2018]])에 한정되었다. [[ref:chae2019|Chae 2019]]는 인간 CRY 시스템이 RPM을 통해 지자기장에 반응한다는 필요조건을 입증하지만, 이 반응에 대한 RF 교란은 테스트하지 않았다(판별 테스트 D1–D3 대기).",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "이는 BERM 경로 C(EMF → 송과체 melatonin 억제 → GnRH 박동 교란 → HPG → 생식선 기능)를 직접 지지한다. 20–50% 억제는 생물학적으로 유의하며 EMF를 야간 삼중 타격(melanopsin + CRY + melatonin 억제)의 한 요소로 두는 v17_night_fraction()과 일치한다. 빛 유도 억제보다 작은 것도 EMF가 유일한 동인이 아니라 여러 야간 교란 경로 중 하나라는 모델과 일치한다. 방법론적 주의: 높은 기준을 충족한 연구는 27%뿐이고 동물 연구의 48%는 적절한 sham 대조군이 없었다. 세포 효과에서 전신 일주기 교란으로의 전이는 임상적으로 완전히 확립되지 않았다.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "관련 항목: 눈 색상과 자기수용 — 홍채 색소, 영양, 성별이 CRY 감수성을 조절한다. 파란 눈은 갈색 눈보다 망막 cryptochrome에 약 100배 더 많은 빛을 전달한다([[ref:higuchi2007|Higuchi 2007]]: melatonin 억제 89% 대 73%). 비타민 B2의 FAD 가용성은 CRY 안정성과 자기장 방향 선택성을 직접 제어한다([[ref:hirano2017|Hirano 2017]], [[ref:yap2025|Yap/Sherrard 2025]]). 이 조절인자들은 경로 C 효과의 개인 간·인구 간 변이 일부를 설명할 수 있다.",
        ],
        studies: [
