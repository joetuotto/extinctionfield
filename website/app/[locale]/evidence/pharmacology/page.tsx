  ...
  en: {
    ...
    cards: [
      ...
      },
      {
        ...
        evidence: [
          "[[ref:tbahriti2026|Tbahriti ym. 2026]] (Sleep Biol Rhythms, PRISMA-katsaus 55 tutkimuksesta): 88 % korkealaatuisista eläintutkimuksista raportoi EMF:n aiheuttaman melatoniinisuppression 20–50 % lähtötasosta.",
      ...
      },
      {
        ...
        evidence: [
          "[[ref:bektas2026|Bektas ym. 2026]] (Bioelectromagnetics): 3,5 GHz RF (5G-taajuus) aiheutti kivesten ja oksidatiivista vauriota rotilla. CoQ10-supplementaatio lievitti vauriota. Ensimmäinen suora osoitus siitä, että antioksidanttilisä suojaa 5G-taajuuden reproduktiiviselta vauriolta.",
        ...
        interpretation: "CoQ10 on BERM:n palautumisikkunan farmakologinen analogi: sen sijaan että vähennettäisiin altistusaikaa, se tehostaa korjausnopeutta. [[ref:bektas2026|Bektas 2026 -tulos]] on vahvin yksittäisen tutkimuksen evidenssi farmakologisesta EMF-suojauksesta.",
        level: "E",
      },
      {
        id: "PSILOCYBIN",
      ...
      },
      {
        ...
        evidence: [
          "Ihmisen siittiöt: NNC 55-0396 salppaa CatSper-virran ja kumoaa progesteronin indusoimat Ca²⁺-transientit ([[ref:pmc6104424_nnc|Rennhack ym. 2018]])",
          "Motiliteetti (progressiivinen A+B) laskee merkittävästi 30 min kuluessa käsittelystä",
          "Akrosomireaktio estetty — siittiö ei pysty läpäisemään zona pellucidaa",
        ],
        interpretation: "Kemiallinen CatSper-salppaus toistaa täsmälleen fenotyypin, jonka BERM ennustaa EMF-altistuksesta: liikkuvat siittiöt, jotka eivät pysty navigoimaan tai hedelmöittämään.",
        level: "E",
      },
      {
        id: "A23187",
        ...
        evidence: [
          ...
          "Ca²⁺-dynamiikalla ionoforin jälkeen on edelleen merkitystä — jatkuva korkea Ca²⁺ ilman oskillaatiota heikentää hyperaktivaatiota",
        ],
      ...
      },
      {
        ...
        mechanism: "Estää keramidi-1-fosfaattisignalointia, joka säätelee zona pellucida -indusoitua akrosomireaktiota solunsisäisen Ca²⁺-mobilisaation kautta.",
        evidence: [
          "Estää zona-indusoidun akrosomireaktion kapasitoiduissa ihmisen siittiöissä ([[ref:pmc10102357_ceram|Rehfeld ym. 2023]])",
          "Ei vaikuta spontaaniin akrosomireaktioon — spesifinen reseptorivälitteiselle reitille",
