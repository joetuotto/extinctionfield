...
const COPY = {
  en: {
    ...
    findingIOPScoping: "Scoping review: BBB-evidenssi ristiriitaista mutta positiivinen useissa itsenäisissä laboissa",
    ...
    findingPresenilinMutations: "Preseniini-mutaatiot → Ca²⁺-dysregulaatio (geneettinen konvergenssi)",
