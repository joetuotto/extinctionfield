...
const COPY = {
  en: {
    ...
    catsperLead: "CatSper is indispensable for several late sperm functions, including capacitation and guidance. Genetic loss and pharmacological blockade establish this biological bottleneck. They do not by themselves establish direct electromagnetic gating of human CatSper.",
    catsperP1: "CatSper is a sperm-specific calcium channel regulated by voltage, pH, temperature and progesterone. BERM therefore identifies its timing as a high-value endpoint for a direct exposure experiment. The proposed EMF → CatSper step remains open until patch-clamp or matched calcium-response data demonstrate it under a specified field protocol.",
    ...
    catsperLead: "CatSper on välttämätön useille siittiön myöhäisvaiheen toiminnoille, kuten kapasitaatiolle ja suunnistukselle. Geneettinen menetys ja farmakologinen salpaus osoittavat biologisen pullonkaulan. Ne eivät yksin osoita ihmisen CatSperin suoraa sähkömagneettista portitusta.",
    catsperP1: "CatSper on siittiöspesifinen kalsiumkanava, jota säätelevät jännite, pH, lämpötila ja progesteroni. BERM nimeää siksi sen ajoituksen korkean arvon päätepisteeksi suoralle altistuskokeelle. Ehdotettu EMF → CatSper -askel pysyy avoimena, kunnes patch-clamp- tai sovitettu kalsiumvastedata osoittaa sen määritellyssä kenttäprotokollassa.",
