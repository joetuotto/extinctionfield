  ...
  en: {
    ...
    narratives: [
      {
        ...
        paragraphs: [
          ...
          "Compare cortical DC stimulation and ambient RF only after their frequency-dependent tissue transfer and receptor coupling are specified. Equal V/m numbers do not identify the same intracellular driver. The [[ref:ttfields_patent_7016725|TTFields patent]] names gonadal tissues as a design concern; a patent does not measure reproductive harm from LED drivers. These examples motivate controlled translation experiments.",
        ],
        studies: [
          ...
          { citation: "Kim et al. (Cell)", year: 2026, referenceId: "kim2026_cell_gene_switch", note: "Engineered CYB5B-dependent gene response; 60 Hz bursts with 4 kHz intraburst structure; sensing versus mediation remains to be separated" },
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "[[ref:bertagna2025|Bertagna 2025]] reported reduced inward and transient outward currents in mouse CA1 neurons after 50 Hz, 1 mT exposure. Interfering with either RyR-mediated release or SERCA-mediated reuptake prevented the response. These interventions constrain a coupled ER–cytosol–membrane system; they do not prove independent channels of damage or direct S4 forcing. The next test measures the first calcium signal, ER-store trajectory and later function together, preserving the ELF protocol rather than transferring it directly to RF.",
        ],
        studies: [
      ...
      },
      {
        ...
        studies: [
          ...
          { citation: "Eliyahu et al. (Bioelectromagnetics)", year: 2006, referenceId: "eliyahu2006", note: "n=36, 890 MHz, 2h: lateralized RT effect — supports three-channel spatial structure" },
    ...
    narratives: [
      {
        ...
        paragraphs: [
          ...
          "Vertaa aivokuoren DC-stimulaatiota ja ympäristön RF:ää vasta taajuusriippuvaisen kudossiirron ja vastaanotinkytkennän määrittelyn jälkeen. Yhtä suuret V/m-luvut eivät tunnista samaa solunsisäistä ajuria. [[ref:ttfields_patent_7016725|TTFields-patentti]] nimeää sukurauhaskudokset suunnittelussa huomioitaviksi; patentti ei mittaa LED-ajurien lisääntymishaittaa. Esimerkit motivoivat kontrolloituja siirtokokeita.",
        ],
        studies: [
          ...
          { citation: "Kim ym. (Cell)", year: 2026, referenceId: "kim2026_cell_gene_switch", note: "Rakennettu CYB5B-riippuvainen geenivaste; 60 Hz:n purskeet ja 4 kHz:n purskeensisäinen rakenne; vastaanotto ja välitys erotettava" },
      ...
      },
      {
        ...
        studies: [
          { citation: "Koivisto ym. (NeuroReport)", year: 2000, referenceId: "koivisto2000", note: "Kaksi kaksoissokkokokeetta (n=48+48): 902 MHz → fasilitaatio. Ei toistettu (Haarala 2003, 2005)." },
          { citation: "Eliyahu ym. (Bioelectromagnetics)", year: 2006, referenceId: "eliyahu2006", note: "n=36, 890 MHz, 2 h: lateralisoitunut RT-vaikutus — tukee kolmikanavamallia" },
    ...
    paradoxCards: [
      ...
      },
      {
        ...
        text: "Novocuren TTFields-patentti ([[ref:ttfields_patent_7016725|US 7 016 725]]) toteaa nimenomaisesti, että ‘munasarjojen tai kivesten solut voivat olla herkkiä sähkökentille’ taajuudella 100–300 kHz — samalla taajuusalueella kuin LED-valaistuksen hakkuriteholähteet, joita on jokaisessa nykyrakennuksessa.",
      },
      {
