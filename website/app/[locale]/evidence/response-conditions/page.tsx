...
const COPY = {
  en: {
    ...
    statusText: "The literature closes several literature-search gaps. It supports state-dependent response families involving phase, coherence duration, pulse shape, developmental timing, receptor or agonist state, redox state, organ transfer and co-exposure. It does not close BERM's geometry-to-tissue calibration gap.",
    ...
    statusText: "Kirjallisuus sulkee useita kirjallisuushakuaukkoja. Se tukee tilariippuvaisia vasteperheitä, joissa olennaisia ovat vaihe, koherenssiaika, pulssimuoto, kehityksellinen ajoitus, reseptori- tai agonistitila, redox-tila, elinsiirto ja yhteisaltistus. Se ei sulje BERM:n geometria–kudos-kalibrointiaukkoa.",
