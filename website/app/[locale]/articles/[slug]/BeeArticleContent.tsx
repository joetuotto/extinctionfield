  ...
  en: {
    ...
    sections: [
      ...
      [
        ...
        "And [[ref:favre_johansson_2025|Favre and Johansson’s Faraday experiment]] demonstrates the underlying principle: bees need Earth’s natural electromagnetic environment (the Schumann resonance) but are harmed by the artificial electromagnetic environment that we have layered on top of it.",
      ],
      [
    ...
    sections: [
      [
        "Vuonna [[ref:favre_johansson_2025|2025 sveitsiläinen biologi Daniel Favre ja ruotsalainen neurotieteilijä Olle Johansson]] julkaisivat tutkimuksen, jonka olisi pitänyt olla etusivun uutinen. He asettivat mehiläisyhdyskuntia Faradayn häkkeihin — metallikotelointeihin, jotka estävät kaikki sähkömagneettiset kentät. Mehiläiset, suojattuina jokaiselta radiosignaalilta, Wi-Fi-lähetykseltä ja voimalinjakentältä ympäristössään, romahtivat nopeasti. Kuningattaret lopettivat hedelmöitettyjen munien munimisen. Työläiset desorientoituivat. Muutamassa viikossa yhdyskunnat olivat kuolleita.",
      ...
      [
        ...
        "Ja [[ref:favre_johansson_2025|Favren ja Johanssonin Faraday-koe]] osoittaa taustalla olevan periaatteen: mehiläiset tarvitsevat Maan luonnollista sähkömagneettista ympäristöä (Schumannin resonanssia), mutta niille on vahingollista keinotekoinen sähkömagneettinen ympäristö, jonka olemme kerrostaneet sen päälle.",
      ],
      [
