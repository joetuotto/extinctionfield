  ...
  en: {
    ...
    sections: [
      [
        ...
        "Mutta tässä on osa joka muuttaa kaiken: kun tutkijat toivat yhden taajuuden takaisin suojattuun pesään — Schumannin resonanssin, Maan luonnollisen sähkömagneettisen \"sydämenlyönnin\" taajuudella 7,83 Hz — yhdyskunnat selvisivät.",
