  ...
  en: {
    ...
    sections: [
      ...
      [
        ...
        "Novocure received a second FDA approval in 2015 for mesothelioma, and a third in 2026. The EF-14 phase III trial demonstrated a median survival increase from 16 to 20.9 months — a result significant enough to change the standard of care for the deadliest brain cancer.",
        "The Novocure patent — US 7,016,725 — contains a sentence that should appear in every discussion of electromagnetic safety. In describing which cells are most susceptible to disruption by intermediate-frequency fields, the patent states that 'cells in the ovaries or testicles may be sensitive to the electric fields.' The patent identifies a cell size–frequency relationship: the optimal disruption frequency is inversely proportional to cell diameter. For spermatogonia — the precursor cells of sperm, approximately 12 micrometers in diameter — the predicted resonant frequency is approximately 310 kilohertz.",
        "This is the same frequency range produced by the switch-mode power supplies inside LED light bulbs: 20 to 200 kilohertz.",
      ],
      [
        "At the high end of the spectrum, the biological activity of electromagnetic radiation becomes so obvious that we have a special word for it: vision. The human retina responds to individual photons carrying approximately 10⁻¹⁹ joules of energy. Photobiomodulation therapy — red and near-infrared light applied to tissue — holds FDA clearance for wound healing and pain management. Blue light phototherapy for neonatal jaundice has been standard care for decades. Ultraviolet phototherapy treats psoriasis and eczema.",
    ...
    references: [
      "Flow Neuroscience tDCS (FDA PMA, December 2025). Therapeutic cortical field: 0.3–1.0 V/m DC.",
      "Novocure Optune TTFields (FDA PMA P100034, 2011/2015/2026). EF-14: median OS 20.9 vs 16.0 months. Patent US 7,016,725.",
      "EBI Bone Healing System (FDA PMA, 1979). PEMF non-thermal bone healing, 1–100 Hz.",
      "Panagopoulos DJ et al. (2025). A comprehensive mechanism of biological and health effects of anthropogenic ELF and WC EMFs. Frontiers in Public Health, 13:1585441. IFO threshold: 10⁻⁵ V/m.",
      "Trus MD, Atlas D (2024). Non-ionotropic VGCC signaling: conformational change without ion flux. Nature Reviews Neuroscience.",
      "Vaziri A, Bhatt D et al. (2016). Direct detection of a single photon by humans. Nature Communications, 7, 12172.",
      "ICNIRP (2020). Guidelines for limiting exposure to electromagnetic fields (100 kHz to 300 GHz). Health Physics, 118(5), 483–524.",
      "Campisi A et al. (2010). Reactive oxygen species levels and DNA fragmentation on astrocytes in primary culture after acute exposure to low intensity microwave. Neuroscience Letters, 473(1), 52–55.",
    ...
    sections: [
      ...
      [
        ...
        "Novocure sai toisen FDA-hyväksynnän 2015 mesoteliooman hoitoon ja kolmannen 2026. EF-14-vaiheen III tutkimus osoitti mediaanin elossaoloajan pidentymisen 16:sta 20,9 kuukauteen.",
        "Novocuren patentti — US 7 016 725 — sisältää lauseen, jonka pitäisi esiintyä jokaisessa sähkömagneettisen turvallisuuden keskustelussa. Patentti toteaa, että 'munasarjojen tai kivesten solut voivat olla herkkiä sähkökentille'. Patentti tunnistaa solukoko–taajuussuhteen: optimaalinen häiriötaajuus on kääntäen verrannollinen solun halkaisijaan. Spermatogonioille — siittiöiden esisoluille, halkaisijaltaan noin 12 mikrometriä — ennustettu resonanssitaajuus on noin 310 kilohertsiä.",
        "Tämä on sama taajuusalue, jonka LED-lamppujen hakkuriteholähteet tuottavat: 20–200 kilohertsiä.",
      ],
      [
        "Spektrin yläpäässä sähkömagneettisen säteilyn biologinen aktiivisuus on niin ilmeistä, että sille on oma sanansa: näkö. Ihmisen verkkokalvo reagoi yksittäisiin fotoneihin, joiden energia on noin 10⁻¹⁹ joulea. Fotobiomodulaatioterapia — punaista ja lähi-infrapunavaloa kudokseen — on FDA-hyväksytty haavan paranemiseen ja kivunlievitykseen. Sinivaloterapia vastasyntyneiden keltaisuuteen on ollut standardihoitoa vuosikymmeniä. UV-valohoito hoitaa psoriasista ja ekseemaa.",
      ...
      [
        ...
        "Tämän taajuusalueen turvallisuusstandardit — ICNIRPin ohjeet ja IEEE C95.1 — perustuvat termiseen malliin: ne suojaavat kudoksen kuumenemiselta, eivät miltään muulta.",
      ],
      [
      ...
      [
        "Taustalla on syvempi periaate. Ionikanavat, jotka välittävät sähkömagneettista herkkyyttä biologisessa kudoksessa, ovat evoluution parhaiten säilyneitä molekulaarirakenteita. Jänniteohjatut kalsium-, kalium- ja natriumkanavat löytyvät bakteereista ihmisiin. Niiden perusrakenne on säilynyt noin kolme miljardia vuotta.",
    ...
    references: [
      "Flow Neuroscience tDCS (FDA PMA, joulukuu 2025). Terapeuttinen aivokuoren kenttä: 0,3–1,0 V/m DC.",
      "Novocure Optune TTFields (FDA PMA P100034, 2011/2015/2026). EF-14: mediaani OS 20,9 vs. 16,0 kk. Patentti US 7 016 725.",
      "EBI Bone Healing System (FDA PMA, 1979). PEMF:n ei-terminen luunparaneminen, 1–100 Hz.",
      "Panagopoulos DJ ym. (2025). A comprehensive mechanism of biological and health effects of anthropogenic ELF and WC EMFs. Frontiers in Public Health, 13:1585441. IFO-kynnys: 10⁻⁵ V/m.",
      "Trus MD, Atlas D (2024). Non-ionotropic VGCC signaling. Nature Reviews Neuroscience.",
      "Vaziri A, Bhatt D ym. (2016). Direct detection of a single photon by humans. Nature Communications, 7, 12172.",
      "ICNIRP (2020). Guidelines for limiting exposure to electromagnetic fields (100 kHz – 300 GHz). Health Physics, 118(5), 483–524.",
      "Campisi A ym. (2010). Reactive oxygen species levels and DNA fragmentation. Neuroscience Letters, 473(1), 52–55.",
      "Zakon HH (2012). Adaptive evolution of voltage-gated sodium channels: the first 800 million years. PNAS, 109(Suppl 1), 10619–10625.",
    ],
  },
} as const;
