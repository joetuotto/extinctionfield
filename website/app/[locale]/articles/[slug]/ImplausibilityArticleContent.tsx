  ...
  en: {
    ...
    sections: [
      ...
      [
        ...
        "BERM's proposed χ(Ā) closure represents a saturating background dependence. Whether perturbation response depends on field frequency relative to ion-channel time constants is a testable mechanism claim; it has not been derived from Lindgren geometry and the L2 coupling is open.",
      ],
      [
      ...
      [
        ...
        "BERM proposes χ(Ā) as a shared closure under which the three candidate mechanisms can be compared. This unifying interpretation is a testable BERM hypothesis, not a common physical foundation derived by Lindgren.",
      ],
      [
        ...
        "BERM proposes that ion-channel density can moderate response, making a CACNA1C genotype interaction a discriminating test. The direction and magnitude require replication and calibration; χ(Ā) does not derive them from Lindgren geometry.",
      ],
      [
        ...
        "Why the criticism is not decisive: macroscopic field-energy estimates do not by themselves test a receptor-specific coupling. BERM proposes a membrane-level response, but its L2 operator and quantitative transfer remain open rather than calculated by Lindgren's metric.",
      ...
      [
        ...
        "BERM's χ(Ā) closure formalizes a candidate saturation hypothesis. It does not establish that a tiny external perturbation produces a maximal biological response; that claim depends on the unresolved L2 operator and endpoint data.",
    ...
    sections: [
      ...
      [
        ...
        "BERM:n ehdottama χ(Ā)-sulkeuma kuvaa saturoituvaa taustariippuvuutta. Väite vasteen riippuvuudesta kentän taajuussisällöstä suhteessa ionikanavan aikavakioihin on testattava mekanismiväite; sitä ei ole johdettu Lindgrenin geometriasta ja L2-kytkentä on avoin.",
      ],
      [
      ...
      [
        ...
        "BERM ehdottaa χ(Ā):ta yhteiseksi sulkeumaksi, jonka alla kolmea ehdokasmekanismia voidaan verrata. Yhdistävä tulkinta on testattava BERM-hypoteesi, ei Lindgrenin johtama yhteinen fysikaalinen perusta.",
      ],
      [
        ...
        "BERM ehdottaa ionikanavatiheyden moderoivan vastetta, jolloin CACNA1C-genotyyppi-interaktio on erotteleva testi. Suunta ja vaikutuksen suuruus vaativat replikaation ja kalibroinnin; χ(Ā) ei johda niitä Lindgrenin geometriasta.",
      ],
      [
        "[[ref:kim2026_cell_gene_switch|Kim 2026]]: ”Incredibly implausible”",
        ...
        "Miksi kritiikki ei ole ratkaiseva: makroskooppinen kenttäenergia ei yksin testaa reseptorikohtaista kytkentää. BERM ehdottaa kalvotason vastetta, mutta L2-operaattori ja määrällinen siirto ovat avoimia eivätkä Lindgrenin metriikan laskemia.",
      ...
      [
        ...
        "BERM:n χ(Ā)-sulkeuma formalisoi ehdokkaan saturaatiohypoteesin. Se ei osoita, että pieni ulkoinen perturbointi tuottaa maksimaalisen biologisen vasteen; väite riippuu ratkaisemattomasta L2-operaattorista ja päätepistedatasta.",
  ...
  ja: {
    ...
    sections: [
      ...
      [
        ...
        "BERMが提案するχ(Ā)閉包は飽和する背景依存性を表す。周波数とチャネル時定数に依存する応答は検証すべき機構仮説であり、Lindgren幾何学からの導出ではなくL2は未解決である。",
      ],
      [
      ...
      [
        ...
        "BERMはχ(Ā)を3候補機構の共通比較枠として提案する。この統一は検証仮説であり、Lindgrenが導出した共通物理基盤ではない。",
      ],
      [
        ...
        "BERMはチャネル密度が応答を修飾すると提案し、CACNA1C相互作用を識別試験とする。方向と大きさは再現・校正が必要で、χはLindgren幾何学から導出しない。",
      ],
      [
        ...
        "巨視的エネルギー推定だけでは受容体特異的結合を検証できない。BERMは膜応答を提案するが、L2演算子と定量的伝達は未解決である。",
      ...
      [
        ...
        "BERMのχ(Ā)閉包は飽和候補を形式化するが、微小な外部摂動が最大生物応答を生むことは示さない。その主張は未解決L2演算子とエンドポイントデータに依存する。",
  ...
  fr: {
    ...
    sections: [
      ...
      [
        ...
        "La fermeture χ(Ā) proposée par BERM représente une dépendance saturante au fond. La réponse membranaire reste une hypothèse de mécanisme à tester ; elle n'est pas dérivée de la géométrie de Lindgren et L2 reste ouvert.",
      ],
      [
      ...
      [
        ...
        "BERM propose χ(Ā) comme cadre commun pour comparer trois mécanismes candidats. Cette unification est une hypothèse testable, pas une base physique commune dérivée par Lindgren.",
      ],
      [
      ...
      [
        ...
        "Une estimation énergétique macroscopique ne teste pas à elle seule un couplage propre au récepteur. BERM propose une réponse membranaire, mais l'opérateur L2 et le transfert quantitatif restent ouverts.",
      ...
      [
        ...
        "La fermeture χ(Ā) de BERM formalise une saturation candidate, mais n'établit pas qu'une faible perturbation externe produit une réponse biologique maximale ; cela dépend de L2 et des données d'endpoint.",
  ...
  ko: {
    ...
    sections: [
      ...
      [
        ...
        "BERM의 제안된 χ(Ā) 폐쇄는 포화 배경 의존성을 표현한다. 막 반응은 검증할 기전 가설이며 Lindgren 기하학에서 도출되지 않았고 L2는 열려 있다.",
      ],
      [
      ...
      [
        ...
        "BERM은 χ(Ā)를 세 후보 기전을 비교하는 공통 틀로 제안한다. 이 통합은 검증 가설이지 Lindgren이 도출한 공통 물리 기반이 아니다.",
      ],
      [
      ...
      [
        ...
        "거시적 에너지 추정만으로 수용체별 결합을 검증할 수 없다. BERM은 막 반응을 제안하지만 L2 연산자와 정량 전달은 열려 있다.",
      ...
      [
        ...
        "BERM의 χ(Ā) 폐쇄는 후보 포화를 형식화하지만 작은 외부 교란이 최대 생물학적 반응을 만든다고 확립하지 않는다. 이는 열린 L2 연산자와 종점 자료에 달려 있다.",
