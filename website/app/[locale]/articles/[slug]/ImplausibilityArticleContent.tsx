  ...
  en: {
    ...
    sections: [
      ...
      [
        ...
        "The algebraic coefficient χ(Ā)=Ā/√(1+Ā²) is always L1. Choosing the positive magnitude |Ā| by an explicit Lorentz-to-Euclidean spatial/scalar reduction is L2: the directed derivative then evaluates χ(|Ā|). Applying it to frequency-dependent ion-channel response is a separate, testable L2 mechanism claim.",
      ],
      [
      ...
      [
        ...
        "The algebraic χ(Ā) coefficient and its saturation property remain L1. Choosing |Ā| by the spatial/scalar reduction is L2; whether a tiny external perturbation produces a maximal biological response depends separately on the unresolved L2 operator and endpoint data.",
    ...
    sections: [
      ...
      [
        ...
        "Algebrallinen kerroin χ(Ā)=Ā/√(1+Ā²) on aina L1. Positiivisen itseisarvon |Ā| valinta eksplisiittisellä Lorentz→Euklidisella spatiaalisella/skalaari-reduktiolla on L2: suunnattu derivaatta evaluoi tällöin χ(|Ā|):n. Sen soveltaminen taajuusriippuvaiseen ionikanavavasteeseen on erillinen, testattava L2-mekanismiväite.",
      ],
      [
      ...
      [
        ...
        "Algebrallisen χ(Ā)-kertoimen saturaatio-ominaisuus on aina L1. |Ā|:n valinta spatiaalisella/skalaari-reduktiolla on L2; se, tuottaako pieni ulkoinen perturbointi maksimaalisen biologisen vasteen, riippuu erikseen ratkaisemattomasta L2-operaattorista ja päätepistedatasta.",
  ...
  ja: {
    ...
    sections: [
      ...
      [
        ...
        "代数式χ(Ā)=Ā/√(1+Ā²)は常にL1である。明示的なLorentz→Euclid空間・スカラー縮約で正の大きさ|Ā|を選ぶ段階はL2であり、方向微分はそこでχ(|Ā|)を評価する。周波数依存のイオンチャネル応答への適用は別の検証可能なL2機構仮説である。",
      ],
      [
      ...
      [
        ...
        "χ(Ā)の代数式と飽和性は常にL1である。空間・スカラー縮約による|Ā|の選択はL2であり、微小な外部摂動が最大生物応答を生むかは別途、未解決L2演算子とエンドポイントデータに依存する。",
  ...
  fr: {
    ...
    sections: [
      ...
      [
        ...
        "La formule algébrique χ(Ā)=Ā/√(1+Ā²) reste toujours L1. Le choix de la norme positive |Ā| par une réduction spatiale/scalaire explicite de Lorentz vers Euclide est L2 : la dérivée directionnelle évalue alors χ(|Ā|). Son application à la réponse membranaire est l'hypothèse mécanistique L2 distincte à tester.",
      ],
      [
  ...
  ko: {
    ...
    sections: [
      ...
      [
        ...
        "대수식 χ(Ā)=Ā/√(1+Ā²)는 항상 L1이다. 명시적인 Lorentz→Euclid 공간·스칼라 축약으로 양의 크기 |Ā|를 선택하는 단계는 L2이며, 방향미분은 그때 χ(|Ā|)를 평가한다. 이를 막 반응에 적용하는 단계는 별도의 검증 가능한 L2 기전 가설이다.",
      ],
      [
