...
const COPY = {
  en: {
    ...
    v2Title: "FieldState v2 calibration status",
    v2Status: "FieldState v2 is a measurement module and publishes no forecast. A future BERM route using FieldState would require matched local measurements, registered organ and couple endpoints, ASFR modelling and external temporal validation before a forecast could be locked.",
    v2Note: "Any future BERM prediction that uses calibrated FieldState inputs will be published alongside these scalar-proxy predictions for comparison.",
    ...
    metabPredictions: [
      ...
      {
        id: "METAB-3",
        title: "GLP-1/L-channel signalling shows a protocol-dependent field interaction",
        description: "Revised conditional test: in MIN6 or another declared β-cell system, cross field/sham with GLP-1/control and measure local Ca²⁺, whole-cell Ca²⁺ and early/sustained ERK. [[ref:bhatt2012_glp1|Selway 2012]] provides the non-field microdomain anchor. Compare BAPTA/EGTA and effective L-channel inhibition on a common measurement scale. The earlier expectation of greater semaglutide benefit at higher ambient EMF is an additional, unvalidated hypothesis; neither its sign nor a threshold follows from Selway’s experiment.",
        timeline: "3-5 years (clinical data mining from existing RCTs)",
        falsification: "Under a prespecified tissue/protocol/assay model, no reproducible field×GLP-1 interaction or the predicted buffering/channel pattern fails. A population correlation alone does not test this cellular mechanism.",
      },
      {
        id: "METAB-4",
    ...
    pharmLead: "Drug–field predictions require a named channel, tissue, waveform and measurement window. Clinical prescription comparisons can motivate tests, but drug effects on normal physiology and treatment selection must be separated from a field×drug interaction.",
    pharmPredictions: [
      {
        id: "PHARM-1",
    ...
    sidsPredictions: [
      ...
      },
      {
        ...
        description: "Measure maternal light and local fields, the timing and concentration of milk melatonin, and a named infant circadian endpoint. Night-milk melatonin is a time signal with tissue-dependent receptor effects, not a universal Ca²⁺ antagonist. An EMF-related change and its infant functional consequence require separate contrasts; the rat MT2 cell result supplies no infant dose coefficient.",
    ...
    investigationPredictions: [
      ...
      { id: "RECOV-2", title: "Measure the recovery curve and test the 4–6-hour candidate window", description: "The previously proposed 4–6-hour interval is an uncalibrated candidate. In a measured exposure/withdrawal protocol, sample receptor state, calcium/CaMKII markers, repair flux, absolute damage and function across multiple pause durations. Fit and test recovery times independently; do not assume negligible recovery before four hours or equate a 20-hour delayed protective effect with a molecular time constant.", falsification: "No dose-response relationship between EMF-free hours and recovery markers" },
    ...
    statusBarAria: "Status bar: 4 verified, 342 pending, 0 CI exceeded",
    ...
    v2Title: "FieldState v2:n kalibrointitila",
    v2Status: "FieldState v2 on mittausmoduuli eikä julkaise ennusteita. Tuleva FieldStatea käyttävä BERM-reitti tarvitsisi kohdistetut paikalliset mittaukset, rekisteröidyt elin- ja paripäätepisteet, ASFR-mallinnuksen ja ulkoisen ajallisen validoinnin ennen ennusteen lukitsemista.",
    v2Note: "Mahdollinen tuleva kalibroituja FieldState-syötteitä käyttävä BERM-ennuste julkaistaan näiden skalaariproxyennusteiden rinnalla vertailua varten.",
    ...
    nutritionalPredictions: [
      {
        ...
        description: "RCT: B2-lisä (25 mg/vrk x 8 viikkoa) vs. plasebo koehenkilöillä joilla on huono unenlaatu ja runsas yöllinen puhelinkäyttö. Ensisijainen päätetapahtuma: melatoniinin alkamisviive. Toissijaiset: unitehokkuus, kortisolin herätysvaste. B2-ryhmän tulisi osoittaa vähemmän sirkadiaanista häiriötä koska FAD-kylläinen CRY on stabiilimpi EMF-perturbaatiota vastaan. Mekanistinen perusta: [[ref:hirano2017|Hirano 2017]] (FAD → CRY-stabiilisuus), [[ref:iversen2025|Iversen 2025]] (FAD → magneettinen herkkyys).",
    ...
    metabPredictions: [
      ...
      {
        id: "METAB-3",
        title: "GLP-1/L-kanavan signaloinnissa on protokollariippuvainen kenttäinteraktio",
        description: "Tarkennettu ehdollinen testi: ristiintaulukoi MIN6- tai muussa nimetyssä β-solujärjestelmässä kenttä/sham ja GLP-1/verrokki ja mittaa paikallinen Ca²⁺, koko solun Ca²⁺ ja varhainen/pitkäkestoinen ERK. [[ref:bhatt2012_glp1|Selway 2012]] antaa ilman kenttää mitatun mikrodomaaniankkurin. Vertaa BAPTA/EGTA-puskurointia ja tehokasta L-kanavan salpausta yhteisellä mitta-asteikolla. Aiempi oletus suuremmasta semaglutidihyödystä suuremmassa ympäristö-EMF:ssä on erillinen validoimaton hypoteesi; Selwayn koe ei määrää sen suuntaa eikä kynnystä.",
        timeline: "3-5 vuotta (olemassa olevien RCT:iden data-analyysi)",
        falsification: "Ennalta määritellyssä kudos-, protokolla- ja mittausmallissa ei havaita toistettavaa kenttä×GLP-1-interaktiota tai ennustettu puskuri-/kanavaprofiili ei toteudu. Väestökorrelaatio ei yksin testaa solumekanismia.",
      },
      {
        id: "METAB-4",
    ...
    trpc1Lead: "Yhteinen koeasetelma voi erottaa L-tyypin kanavavälityksen, TRPC1:een liittyvän vastaanoton ja myöhemmän korjauksen. Mittaa sekä kenttäkontrasti että interventiokontrasti ennen niiden interaktion tai suhteellisen osuuden estimointia.",
    trpc1Predictions: [
      {
        id: "TRPC1-1",
        title: "CRY2-TRPC1-kalsiumsisäänvirtaus vaikuttaa EMF:n reproduktiovaikutuksiin VGCC:stä riippumatta",
        description: "Risteytä nimetyssä lisääntymissolujärjestelmässä kenttä/sham interventiottoman tilan, L-tyypin salpauksen, TRPC1-muutoksen ja molempien kanssa. Mittaa ensimmäinen kalsium-/virtavaste, ER-varaston muutos, korjaus ja lisääntymistoiminto eri aikoina; lisää geenipalautus tai alavirran ohitus. Vertaa erotusta (kenttä−sham) interventiotilojen välillä ennalta määritellyllä asteikolla. Nifedipiinin jälkeinen jäännös ei ole automaattisesti TRPC1-välitteinen, koska muita VGCC-alatyyppejä ja reittejä jää. Ennuste on toistuva interventioriippuvainen kenttäkontrasti, ei ennalta määrätyt reittiprosentit.",
    ...
    pharmLead: "Lääke–kenttäennusteet tarvitsevat nimetyn kanavan, kudoksen, aaltomuodon ja mittausikkunan. Kliiniset reseptivertailut voivat motivoida kokeita, mutta lääkkeen vaikutus normaaliin fysiologiaan ja hoidon valikoituminen erotetaan kenttä×lääke-interaktiosta.",
    pharmPredictions: [
      {
        id: "PHARM-1",
      ...
      {
        id: "PHARM-5",
        title: "CoQ10 muuttaa vastetta määriteltyyn RF-protokollaan",
        description: "Lähtönä [[ref:bektas2026|Bektas 2026]] (GSM-moduloitu 3,5 GHz rotilla): yhdistä määritelty kenttä/sham ja CoQ10/vehikkeli ja säilytä kaikkien neljän haaran absoluuttiset lähtötasot. Mittaa varhainen virta/Ca²⁺, mitokondrio-/redox-kuorma ja myöhempi kudostoiminta erikseen. Laske I_D = (Y_field+drug − Y_sham+drug) − (Y_field − Y_sham) vain samalla asteikolla, samoissa yksiköissä ja samana ajankohtana. Ihmisen annossiirto sekä älypuhelinkäytön ja paikallisten kudoskenttien yhteys tarvitsevat erillisen tunnistamisen; koe ei määrää ihmisannosta tai korjausvakiota.",
        timeline: "6–12 kuukautta (RCT toteutettavissa olemassa olevalla lisäravinteella)",
        falsification: "Ennalta määritelty kenttä×CoQ10-kontrasti puuttuu riittävällä mittausherkkyydellä tai ennustettu välivaiheprofiili ei toteudu. Lääkkeen päävaikutus molemmissa kenttätiloissa ei osoita kenttäsuojaa.",
        critical: true,
      },
    ],
    ...
    diffPredictions: [
      ...
      },
      {
        ...
        description: "Puberteettitrendit motivoivat prospektiivisen testin, eivät vahvista EMF-mekanismia. Mittaa henkilökohtainen kenttäannos, näyttövalo ja ajoitus, uni, ravinto- ja kemikaalialtisteet sekä kehityksen lähtötila erikseen. Testaa, ennustaako ennalta määritelty annos × kehityshistoria -interaktio ajoitusta näiden muuttujien lisäksi.",
        discriminating: false,
        critical: false,
        level: "M|C",
        verified: false,
    ...
    investigationPredictions: [
      ...
      { id: "RECOV-2", title: "Mittaa palautumiskäyrä ja testaa 4–6 tunnin ehdokasikkuna", description: "Aiemmin ehdotettu 4–6 tunnin väli on kalibroimaton ehdokas. Mittaa vastaanotintila, kalsium/CaMKII-markkerit, korjausvirta, absoluuttinen vaurio ja toiminto useilla taukopituuksilla mitatussa altistus/lopetus-kokeessa. Estimoi ja testaa palautumisajat riippumattomasti; älä oleta palautumista vähäiseksi ennen neljää tuntia tai samasta 20 tunnin viiveellä havaittua suojaa molekyyliaikavakioon.", falsification: "Ei annos-vastetta EMF-vapaiden tuntien ja palautumismerkkiaineiden välillä" },
    ...
    statusBarAria: "Tilapalkki: 4 vahvistettua, 342 odottaa, 0 CI ylitetty",
  ...
  ja: {
    ...
    v2Title: "FieldState v2校正ステータス",
    v2Status: "FieldState v2は測定モジュールであり、予測を公開しません。将来FieldStateを使うBERM経路には、対応する局所測定、登録済み臓器・カップルエンドポイント、ASFRモデリング、外部時間検証が必要です。",
    v2Note: "将来、校正済みFieldState入力を使うBERM予測は、比較のためスカラープロキシ予測と併記されます。",
    histTitle: "歴史的・進化的予測",
    ...
    trpc1Lead: "経路A（VGCC）と経路BのTRPC1カルシウム分岐の独立性をテストする予測。CRY2-TRPC1複合体（[[ref:iversen2025|Iversen et al. 2025]]）はEMF生殖効果がVGCC依存性およびTRPC1依存性成分に薬理学的に分解可能と予測。",
    trpc1Timeline: "タイムライン",
    trpc1Falsification: "反証基準",
    trpc1Locked: "ロック日：2026-08-24",
    trpc1Status: "ロック済み ― テスト待ち",
    pharmTitle: "薬理学的予測",
    pharmLead: "薬物×電磁場予測にはチャネル、組織、波形、測定窓を指定する。処方比較は実験を動機付けるが、通常生理への薬物作用と治療選択を電磁場相互作用から区別する。",
    ...
    statusBarAria: "ステータスバー：検証済み4件、保留342件、CI超過0件",
    statusVerified: "検証済み",
    ...
    metabPredictions: [
      ...
      {
        id: "METAB-3",
        title: "GLP-1/L型チャネル信号のプロトコル依存電磁場相互作用",
        description: "改訂した条件付き試験：MIN6など指定したβ細胞で電磁場/シャム×GLP-1/対照を比較し、局所Ca²⁺、細胞全体Ca²⁺、初期/持続ERKを測る。[[ref:bhatt2012_glp1|Selway 2012]]は電磁場のない微小領域の根拠である。BAPTA/EGTAと有効なL型阻害を共通尺度で比較する。高い環境EMFでセマグルチド効果が大きいという従来仮説は未検証の追加仮説であり、その方向や閾値はこの研究から定まらない。",
        timeline: "3-5 years (clinical data mining from existing RCTs)",
        falsification: "事前規定した組織・プロトコル・測定モデルで再現可能な電磁場×GLP-1相互作用がない、または予測した緩衝/チャネルパターンが成立しない。集団相関だけでは細胞機構を試験できない。",
      },
      {
        id: "METAB-4",
        title: "Obesity prevalence in low-EMF communities remains <10% through 2035",
    ...
    pharmPredictions: [
      ...
      {
        id: "PHARM-5",
        title: "CoQ10による定義されたRF応答の変化",
        description: "[[ref:bektas2026|Bektas 2026]]のGSM変調3.5 GHzラット実験を起点に、電磁場/シャム×CoQ10/溶媒の4群と絶対基礎値を保持する。初期電流/Ca²⁺、ミトコンドリア・酸化還元負荷、後の機能を分ける。同一尺度・単位・時点でのみI_D = (Y_field+drug − Y_sham+drug) − (Y_field − Y_sham)を計算する。ヒト用量とスマートフォン利用から局所組織場への橋渡しは別途必要で、実験はヒト用量や修復定数を定めない。",
        timeline: "6-12 months (RCT feasible with existing supplement)",
        falsification: "十分な感度で事前規定した電磁場×CoQ10差がない、または中間応答が予測に合わない。両条件での薬物主効果は電磁場保護の証拠ではない。",
        critical: true,
      },
    ],
    modIntPredictions: [
    ...
    sidsPredictions: [
      ...
      },
      {
        id: "SIDS-3",
        title: "Maternal EMF exposure correlates with lower breast milk melatonin",
        description: "母親の光と局所場、母乳メラトニンの時刻・濃度、指定した乳児概日指標を測定する。夜間母乳のメラトニンは組織依存の時刻信号で、一律のCa²⁺拮抗物質ではない。EMF関連変化と乳児機能を別の比較で調べ、ラットMT2細胞結果から乳児用量係数を作らない。",
        timeline: "Testable within 6–12 months (lactation cohort with dosimetry)",
        falsification: "No correlation between maternal EMF exposure metrics and night milk melatonin concentration",
      },
      {
  ...
  fr: {
    ...
    v2Title: "Statut de calibration de FieldState v2",
    v2Status: "FieldState v2 est un module de mesure et ne publie aucune prévision. Une future route BERM utilisant FieldState exigerait des mesures locales appariées, des endpoints d’organe et de couple enregistrés, une modélisation ASFR et une validation temporelle externe.",
    v2Note: "Toute future prévision BERM utilisant des entrées FieldState calibrées sera publiée avec ces prévisions par proxy scalaire pour comparaison.",
    ...
    trpc1Lead: "Prédictions testant l'indépendance de la voie A (VGCC) et de la branche calcique TRPC1 de la voie B. Le complexe CRY2-TRPC1 ([[ref:iversen2025|Iversen et al. 2025]]) prédit que les effets reproductifs EMF peuvent être pharmacologiquement décomposés en composantes dépendantes du VGCC et du TRPC1.",
    ...
    pharmLead: "Les prédictions médicament×champ exigent canal, tissu, forme d’onde et fenêtre de mesure définis. Les prescriptions peuvent motiver une étude, mais les effets physiologiques propres au médicament et la sélection du traitement se distinguent de l’interaction avec le champ.",
    ...
    statusBarAria: "Barre d'état : 4 vérifiées, 342 en attente, 0 IC dépassé",
    ...
    metabPredictions: [
      ...
      {
        id: "METAB-3",
        title: "Interaction champ×GLP-1/canal L dépendante du protocole",
        description: "Test conditionnel révisé : dans MIN6 ou un système β défini, croiser champ/sham et GLP-1/témoin ; mesurer Ca²⁺ local, Ca²⁺ moyen et ERK précoce/prolongé. [[ref:bhatt2012_glp1|Selway 2012]] ancre le microdomaine sans champ. Comparer BAPTA/EGTA et inhibition L efficace sur une échelle commune. L’ancienne hypothèse d’un bénéfice du sémaglutide accru avec les EMF reste une hypothèse supplémentaire non validée ; ni son sens ni son seuil ne découlent de cette expérience.",
        timeline: "3-5 years (clinical data mining from existing RCTs)",
        falsification: "Absence d’interaction champ×GLP-1 reproductible dans le modèle tissulaire/protocolaire préspécifié, ou échec du profil tampon/canal prédit. Une corrélation de population ne teste pas seule ce mécanisme cellulaire.",
      },
      {
        id: "METAB-4",
        title: "Obesity prevalence in low-EMF communities remains <10% through 2035",
    ...
    pharmPredictions: [
      ...
      {
        id: "PHARM-5",
        title: "CoQ10 modifie la réponse à un protocole RF défini",
        description: "À partir de [[ref:bektas2026|Bektas 2026]] (3,5 GHz modulé GSM chez le rat), croiser champ/sham et CoQ10/véhicule en conservant les quatre valeurs initiales absolues. Mesurer courant/Ca²⁺ précoce, charge mitochondriale/redox et fonction tardive. Calculer I_D = (Y_field+drug − Y_sham+drug) − (Y_field − Y_sham) seulement avec une échelle, des unités et un temps communs. Le transfert de dose à l’humain et le lien entre usage du téléphone et champ tissulaire nécessitent une identification séparée ; cette étude ne fixe ni dose humaine ni constante de réparation.",
        timeline: "6-12 months (RCT feasible with existing supplement)",
        falsification: "Absence du contraste champ×CoQ10 préenregistré avec une sensibilité suffisante, ou échec de la réponse intermédiaire prédite. Un effet principal du médicament dans les deux conditions ne démontre pas une protection contre le champ.",
        critical: true,
      },
    ],
    modIntPredictions: [
  ...
  ko: {
    ...
    v2Title: "FieldState v2 보정 상태",
    v2Status: "FieldState v2는 측정 모듈이며 예측을 게시하지 않습니다. 향후 FieldState를 사용하는 BERM 경로에는 매칭된 국소 측정, 등록된 장기·커플 엔드포인트, ASFR 모델링 및 외부 시간 검증이 필요합니다.",
    v2Note: "향후 보정된 FieldState 입력을 사용하는 BERM 예측은 비교를 위해 스칼라 프록시 예측과 함께 게시됩니다.",
    ...
    trpc1Lead: "경로 A(VGCC)와 경로 B의 TRPC1 칼슘 분기의 독립성을 테스트. CRY2-TRPC1 복합체([[ref:iversen2025|Iversen et al. 2025]])는 EMF 생식 효과가 VGCC 의존성 및 TRPC1 의존성 구성 요소로 약리학적으로 분해 가능하다고 예측.",
    trpc1Timeline: "타임라인",
    trpc1Falsification: "반증 기준",
    trpc1Locked: "잠금일: 2026-08-24",
    trpc1Status: "잠금 — 테스트 대기 중",
    pharmTitle: "약리학적 예측",
    pharmLead: "약물×장 예측에는 채널, 조직, 파형과 측정 구간이 필요하다. 처방 비교가 시험을 동기화할 수 있지만 정상 생리의 약물 효과와 치료 선택을 장 상호작용에서 구별해야 한다.",
    pharmTimeline: "타임라인",
    ...
    statusBarAria: "상태 바: 검증됨 4건, 대기 중 342건, CI 초과 0건",
    statusVerified: "검증됨",
    ...
    metabPredictions: [
      ...
      {
        id: "METAB-3",
        title: "GLP-1/L형 신호의 프로토콜 의존 장 상호작용",
        description: "수정된 조건부 시험: MIN6 등 지정한 β세포에서 장/sham×GLP-1/대조를 비교하고 국소 Ca²⁺, 세포 전체 Ca²⁺ 및 초기/지속 ERK를 측정한다. [[ref:bhatt2012_glp1|Selway 2012]]는 장 없는 미세영역 근거다. BAPTA/EGTA와 효과적인 L형 억제를 같은 척도로 비교한다. 높은 환경 EMF에서 세마글루티드 이점이 더 크다는 기존 예상은 검증되지 않은 추가 가설이며 이 실험으로 방향이나 역치가 정해지지 않는다.",
        timeline: "3-5 years (clinical data mining from existing RCTs)",
        falsification: "사전 지정 조직·프로토콜·측정 모델에서 재현 가능한 장×GLP-1 상호작용이 없거나 예상한 완충/채널 패턴이 실패한다. 집단 상관만으로 세포 기전을 시험할 수 없다.",
      },
      {
        id: "METAB-4",
        title: "Obesity prevalence in low-EMF communities remains <10% through 2035",
    ...
    pharmPredictions: [
      ...
      {
        id: "PHARM-5",
        title: "CoQ10은 정의된 RF 프로토콜의 반응을 바꾼다",
        description: "[[ref:bektas2026|Bektas 2026]]의 GSM 변조 3.5 GHz 쥐 연구에서 출발해 장/sham×CoQ10/용매 네 군의 절대 기저값을 유지한다. 초기 전류/Ca²⁺, 미토콘드리아·산화환원 부하, 후기 기능을 분리한다. 같은 척도·단위·시점에서만 I_D = (Y_field+drug − Y_sham+drug) − (Y_field − Y_sham)를 계산한다. 사람 용량 이전 및 스마트폰 사용과 국소 조직장의 연결은 별도 식별이 필요하며 연구는 사람 용량이나 복구 상수를 정하지 않는다.",
        timeline: "6-12 months (RCT feasible with existing supplement)",
        falsification: "충분한 감도에서 사전 등록 장×CoQ10 대비가 없거나 예상한 중간 반응이 실패한다. 두 장 조건에 공통인 약물 주효과는 장 보호의 증거가 아니다.",
        critical: true,
      },
    ],
    modIntPredictions: [
    ...
    sidsPredictions: [
      ...
      },
      {
        id: "SIDS-3",
        title: "Maternal EMF exposure correlates with lower breast milk melatonin",
        description: "모체 빛과 국소장, 모유 멜라토닌 시점·농도 및 지정한 영아 일주기 지표를 측정한다. 밤 모유 멜라토닌은 조직 의존 시간 신호이며 보편적 Ca²⁺ 길항제가 아니다. EMF 관련 변화와 영아 기능 결과에는 별도 대비가 필요하고 쥐 MT2 세포 결과는 영아 용량 계수를 주지 않는다.",
        timeline: "Testable within 6–12 months (lactation cohort with dosimetry)",
        falsification: "No correlation between maternal EMF exposure metrics and night milk melatonin concentration",
      },
      {
