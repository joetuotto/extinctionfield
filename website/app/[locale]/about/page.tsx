...
const t: Record<string, Copy> = {
  en: {
    ...
    deepHistoryText: [
      ...
      "BERM formalisoi tämän Pohjoisena pakettina: populaatiotason ehdokasmoderaattorien profiilina. Molekyyli-, optiikka-, solu-, ympäristö- ja populaatiotason toistuvat χ-merkinnät ovat mallinnuksen lyhenteitä, eivät yksi Lindgrenin geometriasta johdettu biologinen valintasääntö. Hypoteesin mukaan sähköistyminen paljastaa populaatioiden heterogeenisuuden päätepistekohtaisen vasteytimen kautta; sen etumerkki, asteikko ja kalibraatio ovat avoimia.",
  ...
  ko: {
    ...
    deepHistoryText: [
      ...
      "BERM은 이를 Northern Package, 즉 인구 수준의 후보 생물학적 조절인자 프로파일로 정식화합니다. 분자·광학·세포·환경·인구 규모에서 반복되는 χ 표기는 모델링 약어이며 Lindgren 기하학에서 도출된 하나의 생물학적 선택 규칙이 아닙니다. 전기화가 종점별 반응 커널을 통해 인구 이질성을 드러낸다는 가설이며 부호·척도·보정은 미해결입니다.",
