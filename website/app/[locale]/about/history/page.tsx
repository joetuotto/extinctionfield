...
const COPY = {
  en: {
    ...
    entries: [
      ...
      ["BERM v19", "The active route now keeps FieldState, organ-local transfer, reversible/persistent organ state, couple capacity, ASFR and TFR distinct. Mobile subscription density serves as a composite proxy for the overall electromagnetic environment."],
    ...
    entries: [
      ...
      ["BERM v19", "Aktiivinen reitti pitää FieldStaten, elinkohtaisen siirron, palautuvan/persistentin elintilan, parikapasiteetin, ASFR:n ja TFR:n erillisinä. Mobiililiittymätiheys toimii yhdistelmäproxyna koko sähkömagneettiselle ympäristölle."],
