...
const COPY = {
  en: {
    ...
    sPoliticalIdeologies: [
      ...
      { name: "Libertarismi", patholog: "vaihteleva", desc: "J\u00e4\u00e4nn\u00f6ksellinen korkean DA:n fenotyyppi. Riskinsietokyvinen, matala konformismi. Kutistuva demografinen pohja DA:n laskiessa." },
    ],
    ...
    sRKLit: [
      ...
      "Flegr 2013 (J Exp Biol): T. gondii manipuloi is\u00e4nn\u00e4n dopamiinia + amygdalan reaktiivisuutta \u2192 k\u00e4ytt\u00e4ytymismuutokset vastaavat r-tyypin piirteit\u00e4. Riippumaton validaatio siit\u00e4, ett\u00e4 dopaminerginen h\u00e4iri\u00f6 tuottaa r-fenotyypist\u00e4 mimikry\u00e4.",
    ...
    <main id="main-content">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <section className="mb-16">
          ...
          <p className="text-sm text-foreground-muted leading-relaxed mb-8">{(d as CopyType).sPoliticalDesc}</p>
        ...
        <section className="mb-16">
          ...
          <p className="text-sm text-foreground-muted mb-6">{(d as CopyType).sMoralDesc}</p>
        ...
        <section className="mb-16">
          ...
          <div className="rounded-xl border border-purple-500/30 bg-purple-500/5 p-5 mb-6">
            <p className="text-sm leading-relaxed">{(d as CopyType).sRKDopamine}</p>
          </div>
          )}
        ...
        <section className="mb-16">
          ...
          <div className="rounded-xl border border-orange-500/30 bg-orange-500/5 p-5 mb-6">
            ...
            <p className="text-sm leading-relaxed">{(d as CopyType).sLCCollectiveDesc}</p>
          </div>
          )}
          ...
          <div className="rounded-xl border border-purple-500/30 bg-purple-500/5 p-5 mb-6">
            ...
            <p className="text-sm leading-relaxed">{(d as CopyType).sLCRatchetDesc}</p>
          </div>
          )}
