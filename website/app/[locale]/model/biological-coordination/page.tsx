...
const COPY = {
  en: {
    ...
    stateSign: "The direction of a biological effect also depends on the starting state. In a hypomagnetic mouse study, a ROS-raising intervention improved neurogenesis under the hypomagnetic condition and impaired it under the geomagnetic control condition. BERM therefore distinguishes the received change, its biochemical intermediary and the tissue’s position within a functional range. [[ref:zhang2021|Zhang 2021]].",
    ...
    encounterText2: "The BERM aggregation follows repeated interactions into relationships, reproduction, care, skill transfer and maintained infrastructure. Institutions store capacities produced by these events. Their replenishment and loss, together with network feedback, give the macro-level response its own time constants. Each network needs its own interaction coefficients and biological inputs.",
    ...
    stateSign: "Myös biologisen vaikutuksen suunta riippuu lähtötilasta. Hypomagneettisessa hiirikokeessa ROS:ia nostava käsittely paransi neurogeneesiä hypomagneettisessa tilassa ja heikensi sitä geomagneettisessa verrokkitilassa. BERM erottaa siksi vastaanotetun muutoksen, sen biokemiallisen välittäjän ja kudoksen sijainnin toiminnallisella alueella. [[ref:zhang2021|Zhang 2021]].",
    ...
    encounterText2: "BERM:n aggregointi seuraa toistuvia vuorovaikutuksia ihmissuhteisiin, lisääntymiseen, hoivaan, osaamisen siirtoon ja infrastruktuurin ylläpitoon. Instituutiot varastoivat näissä tapahtumissa tuotettua kapasiteettia. Sen täydentyminen ja menetys sekä verkostopalaute antavat makrovasteelle omat aikavakionsa. Kunkin verkoston vuorovaikutuskertoimet ja biologiset syötteet määritetään erikseen.",
