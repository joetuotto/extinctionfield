...
const CRITERIA: Criterion[] = [
  {
    ...
    strongest_en: "Pharmacological: ethosuximide → testosterone 'drastically reduced'",
    strongest_fi: "Farmakologinen: etosuksimidi → testosteroni 'drastisesti laskenut'",
  },
  {
    id: "consistency",
    name_en: "Consistency",
    ...
    strongest_en: "6 organs, 4 methodologies, 4 decades, multiple species",
    strongest_fi: "6 elintä, 4 metodologiaa, 4 vuosikymmentä, useita lajeja",
  },
  {
    id: "specificity",
    name_en: "Specificity",
    ...
    strongest_en: "6 VGCC genes → 6 distinct disease profiles",
    strongest_fi: "6 VGCC-geeniä → 6 erillistä sairausprofiilia",
  },
  {
    id: "temporality",
    name_en: "Temporality",
    ...
    strongest_en: "Electrification → TFR decline; COVID WFH → baby bump",
    strongest_fi: "Sähköistyminen → TFR-lasku; COVID-etätyö → baby bump",
  },
  {
    id: "gradient",
    ...
    strongest_en: "Dose-dependent (Lee 2011) + non-monotonic windows (Blackman)",
    strongest_fi: "Annosriippuvainen (Lee 2011) + ei-monotoniset ikkunat (Blackman)",
  },
  {
    id: "plausibility",
  ...
  },
  {
    ...
    name_fi: "Koherenssi",
    berm: 4, tobacco: 4, bpa: 3,
    strongest_en: "No contradictions found; consistent with EDC research",
    strongest_fi: "Ei ristiriitoja; konsistentti EDC-tutkimuksen kanssa",
  },
  {
    id: "experiment",
    ...
    strongest_en: "TheraBionic (FDA, human); 6+ animal studies; pharmacological reversal",
    strongest_fi: "TheraBionic (FDA, ihminen); 6+ eläinkoetta; farmakologinen käänteiskoe",
  },
  {
    id: "analogy",
    name_en: "Analogy",
    ...
    strongest_en: "EDC parallel + pharmacology + Timothy syndrome + TheraBionic",
    strongest_fi: "EDC-paralleli + farmakologia + Timothy syndrooma + TheraBionic",
  },
];
