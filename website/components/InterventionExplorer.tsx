...
const COPY = {
  en: {
    title: "What does an intervention actually test?", intro: "Explore experimental profiles. Channel identity, calcium location, pretreatment and feedback can change the same endpoint in different ways.",
    search: "Search interventions or endpoints", choose: "Choose an experimental profile", empty: "No profiles match. Clear the search to review all profiles.", clear: "Clear search", found: "profiles found", select: "View profile", fallback: "Profile descriptions are available in English and Finnish; English is shown here.",
    ...
    title: "Mitä interventio todella testaa?", intro: "Tutki koeprofiileja. Kanavatyyppi, kalsiumin sijainti, esikäsittely ja palaute voivat muuttaa samaa päätepistettä eri tavoin.",
    search: "Etsi interventiota tai päätepistettä", choose: "Valitse koeprofiili", empty: "Profiileja ei löytynyt. Tyhjennä haku tarkastellaksesi kaikkia profiileja.", clear: "Tyhjennä haku", found: "profiilia löytyi", select: "Näytä profiili", fallback: "Profiilikuvaukset ovat saatavilla englanniksi ja suomeksi.",
