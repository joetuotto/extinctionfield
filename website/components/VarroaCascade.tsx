...
const COPY = {
  en: {
    ...
    p2: "Electromagnetic fields reduce grooming behavior (50 Hz data, Wyszkowska 2025), impair olfactory sensitivity (the primary mechanism for hygienic detection of Varroa-infested brood), trigger stress protein expression (hsp70, hsp90; PLOS ONE 2023), reduce queen laying and brood viability (Odemer 2019), and disrupt magnetic navigation essential for foraging (Shepherd 2023, Science Advances).",
    ...
    beeEffects: [
      { icon: "✗", text: "Grooming ↓ (50 Hz data)" },
      { icon: "✗", text: "Olfaction ↓ (ELF data)" },
      { icon: "✗", text: "Navigation ↓ (CRY/RPM, Shepherd 2023)" },
      { icon: "✗", text: "Stress proteins ↑ (900 MHz, PLOS ONE)" },
    ...
    p2: "Sähkömagneettiset kentät vähentävät sukimiskäyttäytymistä (50 Hz data, Wyszkowska 2025), heikentävät hajuherkkyyttä (ensisijainen mekanismi Varroa-tartunnan saaneen sikiön hygieeniseen havaitsemiseen), laukaisevat stressiproteiinien ilmentymisen (hsp70, hsp90; PLOS ONE 2023), vähentävät kuningattaren munintaa ja sikiön elinkelpoisuutta (Odemer 2019) ja häiritsevät ravinnonhankintaan välttämätöntä magneettinaivgointia (Shepherd 2023, Science Advances).",
    ...
    fieldStateLabel: "FieldState",
    beeEffects: [
      { icon: "✗", text: "Sukiminen ↓ (50 Hz data)" },
      { icon: "✗", text: "Hajuaisti ↓ (ELF data)" },
      { icon: "✗", text: "Navigointi ↓ (CRY/RPM, Shepherd 2023)" },
      { icon: "✗", text: "Stressiproteiinit ↑ (900 MHz, PLOS ONE)" },
