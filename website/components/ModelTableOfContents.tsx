  ...
  en: [
    ...
    },
    {
      ...
      sections: [
        ...
        { id: "testosterone-threshold", label: "T → TFR response calibration" },
    ...
    },
    {
      ...
      sections: [
        ...
        { id: "asfr-tfr", label: "ASFR → TFR" },
        { id: "testosterone-threshold", label: "T → TFR -vasteen kalibrointi" },
  ...
  ja: [
    ...
    },
    {
      ...
      sections: [
        ...
        { id: "asfr-tfr", label: "ASFR → TFR" },
        { id: "testosterone-threshold", label: "T → TFR反応の較正" },
  ...
  fr: [
    ...
    },
    {
      ...
      sections: [
        ...
        { id: "asfr-tfr", label: "ASFR → TFR" },
        { id: "testosterone-threshold", label: "Calibration de la réponse T → TFR" },
  ...
  ko: [
    ...
    },
    {
      ...
      sections: [
        ...
        { id: "asfr-tfr", label: "ASFR → TFR" },
        { id: "testosterone-threshold", label: "T → TFR 반응 보정" },
