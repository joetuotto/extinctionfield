  ...
  return (
    <div
      className={`
        ...
        min-w-[140px] max-w-[170px] px-2.5 py-2 text-left
        ...
        ${!d.dimmed && !selected ? "hover:shadow-[0_0_10px_rgba(255,255,255,0.08)] cursor-pointer" : ""}
      `}
    ...
    >
      ...
      <div
        className="absolute -top-2 -right-2 w-[18px] h-[18px] rounded-full text-[8px] font-bold flex items-center justify-center text-white shadow-sm"
