...
const RETRODICTIONS: Retrodiction[] = [
  ...
  },
  {
    ...
    explanation: {
      ...
      fi: "[[ref:koopman2016_vns_ra|VNS (FDA-hyväksytty nivelreumaan)]] toimii palauttamalla vagaalisen anti-inflammatorisen refleksin. Ympäristö-RF vagushermon lähellä (nappikuulokkeet, puhelin korvalla) häiritsee samaa refleksiä → immuunijärjestelmän yliaktivaatio. Krooninen unihäiriö tuottaa sympaattisen yliaktivaation — autonomisen vastineen anti-VNS:lle — joka suppressoi vagaalisen anti-inflammatorisen refleksin ([[ref:walker2017_why_we_sleep|Walker 2017]]). Tämä on sama mekanismi jonka VNS-laitteet (FDA-hyväksytyt) palauttavat terapeuttisesti.",
