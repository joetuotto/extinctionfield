  ...
  return (
    <div className="rounded-lg border border-card-border bg-card-bg p-4 sm:p-5">
      ...
      <p className="mt-2 text-xs leading-relaxed text-foreground-muted">
        {fi
          ? "Mobiililiittymät ovat teknologian käyttöönoton ajoitusproxy, eivät mitattu EMF-altistus. Ennuste on lukittu BERM v18:lla; hakasulkeet ovat parametriherkkyysalue, eivät luottamusväli."
          : "Mobile subscriptions are a technology-adoption timing proxy, not measured EMF exposure. The prediction is locked under BERM v18; brackets are a parameter sensitivity envelope, not a confidence interval."}
      </p>
    </div>
  );
}
