...
const canonicalDescriptions: Record<string, [number, string, string, string]> = {
  ...
  individual_behavioral_response: [7, "Endocrine, circadian and neural state enter a conditional individual response probability together with context. This probabilistic operator does not assign a deterministic preference or political outcome to a biomarker.", "Hormonaalinen, vuorokausirytminen ja hermostollinen tila tulevat ehdolliseen yksilövasteen todennäköisyyteen yhdessä tilanteen kanssa. Todennäköisyysoperaattori ei määrää biomarkkerista determinististä mieltymystä tai poliittista tulosta.", "/civilization"],
