...
export const NODES: CausalMapNode[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      bermPathway: "Polut A_mitotic, Cyb5b",
  ...
  { id: "mech_cry_melatonin", level: 2, label: "CRY/RPM → melatoniini", epistemicLevel: "E", detail: { mechanism: "Kryptokromin radikaaliparin spin-tila häiriintyy → sirkadiaaninen kello vääristyy → melatoniinisyntesi alenee. Ihmisen CRY/RPM-magnetoreseptio on sinivaloriippuvainen (Chae ym. 2019, P<0,001); pystykomponentin kääntö käänsi orientaation, mikä on yhdenmukainen inklinaatiokompassin kanssa.", bermPathway: "B,C", keyRefs: ["chae2019", "ritz2004_rf_compass", "engels2014_emf_bird", "sherrard2018", "yoshii2009"], link: "/evidence#human-cry-magnetoreception" } },
  ...
  { id: "mech_cyb5b_ca", level: 2, label: "Cyb5b → Ca²⁺ oskillaatiot", sublabel: "Kim 2026 Cell", epistemicLevel: "E", detail: { mechanism: "CRISPR-seulonnalla tunnistettu Cyb5b toimii EMF-sensorina mitokondrion ulkokalvolla. Tuottaa rytmiset Ca²⁺-oskillaatiot jotka aktivoivat geenipromoottoreita. Kolmas transduktioreitti IFO:n ja RPM:n rinnalla. 4 kHz (IF-alue) käytettiin geenikytkin-demonstraatiossa — yhdistää IF-kanavan suoraan geeniekspression kontrollikaskadiin.", bermPathway: "Cyb5b", keyRefs: ["kim2026_cell_emf_gene_switch", "kim2026_cell_gene_switch"], link: "/evidence#lighting-transition" } },
  ...
  { id: "epi_kaiser_series", level: 2, label: "Kaiser Permanente -sarja", sublabel: "Li 2002–2020, EMDEX", epistemicLevel: "E", detail: { mechanism: "De-Kun Li:n 6 kohorttia (n = 801–10 931) Kaiser Permanente -järjestelmässä, EMDEX-mitattu MF-altistus (16 mG -kynnys). 5 päätetapahtumaa 4 BERM-kaskadissa: keskenmeno (2002), sperma ↓ (2010), lapsuusastma (2011), lapsuuslihavuus (2012), ADHD (2020). Li 2017: varhain alkava syöpä (EOC) äitien altistuksesta. Kohorttiasetelma, objektiivinen mittaus, konsistentteja tuloksia eri päätepisteissä.", bermPathway: "IF,A_mitotic", keyRefs: ["li2002_miscarriage_mf", "li2010_sperm_mf", "li2011_asthma_mf", "li2012_obesity_mf", "li2017", "li2020_jama_adhd"], link: "/evidence#kaiser-permanente-series" } },
  { id: "mech_led_confound", level: 2, label: "LED IF-EMF -sekoittaja", sublabel: "65 kHz–2 MHz ajuri", epistemicLevel: "C", detail: { mechanism: "Kaikki LED-valonlähteet sisältävät hakkuriteholähteen (20–300 kHz IF-EMF). Verkkokalvon Cav1.4-kanavat ovat VGCC-tyyppisiä ja IF-EMF:n kohteita. Sinivalotutkimuksissa hehkulamppu vs. LED -vertailu sekoittuu IF-EMF:ään. A2E-fotosensitisaatio on todellinen, mutta IF-EMF voi vahvistaa sitä synergistisesti. Yötila poistaa sinivalon mutta EI IF-EMF:ää. Duraccio 2019: sinisen valon suodatuslasit EIVÄT parantaneet unta — viittaa IF:n rooliin.", bermPathway: "LED confound", keyRefs: ["pmc4896623_cav14", "pmc3885580_retinal_vgcc", "pmc7830240_blue_light", "duraccio2019_blue_light", "ijrb2022_if_review"], prediction: "P19–P22: IF-EMF välittää LED-sinivalovauriota. SLEEP-1: Faraday-suojattu LED vs. suojaamaton.", link: "/evidence#lighting-transition" } },
...
export const EDGES: CausalMapEdge[] = [
  ...
  { from: "ch_if", to: "epi_kaiser_series", label: "EMDEX-mitattu" },
