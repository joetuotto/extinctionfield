...
export const MODULOME_TARGETS: ModulomeTarget[] = [
  {
    ...
    emfEvidenceFi: "2,45 GHz RF-EMR nosti merkittävästi GnRH-tasoja (2026, IJMS). LH:n vapautuminen johtuu pääasiassa Ca²⁺:n noususta. ELF-EMF moduloi solun kalsiumia. 50 Hz 18 viikkoa laski FSH:ta naarasrotilla. GnRH-pulssin TAAJUUS määrää FSH/LH-suhteen — EMF:n häiriö gonadotroopin Ca²⁺-dynamiikassa siirtää tätä suhdetta.",
  ...
  },
  {
    ...
    emfEvidenceFi: "Sakurai 2008: ELF vähensi insuliinisekreetiota ~30 % hamsterin saarekkeissa. Sähkökentän stimulaatio indusoi insuliinisekreetiota L-tyypin VGCC:n kautta ILMAN glukoosia. EMF laski insuliinitasoja ja haiman saarekealaa altistuneilla rotilla.",
    keyRefs: ["sakurai2008"],
    level: "M|C",
    bermPathway: ["A"],
  ...
  },
  {
    ...
    emfEvidenceFi: "Pall 2022: 18 tyyppistä evidenssiä EMF → VGCC → Ca²⁺ → Alzheimer -ketjulle. 34 % aivosolujen kuolema 4 viikossa EMF-altistusta rotilla — estetty VGCC-salpaajalla amlodipiinilla. BBB:n avautuminen → amyloidin pääsy.",
    keyRefs: ["pall2022-ad"],
    level: "M|C",
    bermPathway: ["A", "F"],
    ...
    lindgrenChiFi: "Kaksoisosuma: (1) Cav3.2-bifurkaatio DG:ssä → krooninen Ca²⁺ → amyloidikaskadi. (2) BBB:n avautuminen → veren Aβ pääsee aivoihin. Molemmat konvergoivat hippokampukseen. Ikä vahvistaa mitokondriaalisella χ:llä.",
