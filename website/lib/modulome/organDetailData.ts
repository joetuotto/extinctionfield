...
export const MODULOME_TARGETS: ModulomeTarget[] = [
  ...
  },
  {
    ...
    level: "M|C",
    bermPathway: ["A"],
    bermBridgeEn: "BERM candidate after the open L2 bridge: glucose state may moderate the separately calibrated imported L3 beta-cell response χ_beta. χ_beta is distinct from the restricted L1 coefficient χ_geo.",
    bermBridgeFi: "BERM-ehdokas avoimen L2-sillan jälkeen: glukoositila voi muuntaa erikseen kalibroitavaa tuotua L3-beetasoluvastetta χ_beta. χ_beta on eri suure kuin rajoitettu L1-kerroin χ_geo.",
