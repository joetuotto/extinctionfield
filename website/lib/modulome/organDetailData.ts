...
export const MODULOME_TARGETS: ModulomeTarget[] = [
  {
    ...
    level: "M|C",
    bermPathway: ["A", "D"],
    bermBridgeEn: "BERM candidate after the conditional L2 operator: pituitary location and gonadotroph T-type channels may motivate an HPG-axis test; the tissue kernel is uncalibrated and does not establish an independent EMF→TFR route.",
    bermBridgeFi: "BERM-ehdokas ehdollisen L2-operaattorin jälkeen: aivolisäkkeen sijainti ja gonadotroopin T-tyypin kanavat motivoivat HPG-akselin testiä, mutta kudosydin on kalibroimatta eikä itsenäistä EMF→TFR-reittiä ole osoitettu.",
  ...
  },
  {
    ...
    level: "M|C",
    bermPathway: ["A"],
    bermBridgeEn: "BERM candidate after the conditional L2 operator: Cav3.2 and adrenal location motivate an endpoint-specific aldosterone test; the tissue kernel is uncalibrated and no chronic EMF→hypertension mapping is derived here.",
    bermBridgeFi: "BERM-ehdokas ehdollisen L2-operaattorin jälkeen: Cav3.2 ja lisämunuaisen sijainti motivoivat aldosteronin päätepistetestiä; kudosydin on kalibroimatta eikä kroonista EMF→verenpainetauti-kuvausta johdeta tässä.",
  ...
  },
  {
    ...
    level: "M|C",
    bermPathway: ["A"],
    bermBridgeEn: "BERM candidate after the conditional L2 operator: glucose state may moderate a separately calibrated beta-cell response. The proposed interaction is not supplied by χ_geo and requires a tissue kernel.",
    bermBridgeFi: "BERM-ehdokas ehdollisen L2-operaattorin jälkeen: glukoositila voi moderoida erikseen kalibroitua beetasoluvastetta. χ_geo ei anna tätä interaktiota, vaan se vaatii kudosytimen.",
  ...
  },
  {
    ...
    level: "M|C",
    bermPathway: ["A", "F"],
    bermBridgeEn: "BERM candidate after the conditional L2 operator: Cav3.2, BBB and amyloid endpoints can be tested jointly, but their tissue response, convergence and any age interaction require independent calibration.",
    bermBridgeFi: "BERM-ehdokas ehdollisen L2-operaattorin jälkeen: Cav3.2-, BBB- ja amyloidipäätepisteitä voidaan testata yhdessä, mutta kudosvaste, yhdentyminen ja ikäinteraktio vaativat riippumattoman kalibroinnin.",
  ...
  },
  {
    ...
    emfEvidenceEn: "Blood pressure elevation in EMF-exposed rats (Mohamed). Left ventricular hypertrophy from chronic hypertension. TRPC channels confirmed in ventricular myocytes (arrhythmia substrate). CRY2-TRPC1 in myoblasts (Iversen 2025).",
    emfEvidenceFi: "Verenpaineen nousu EMF-altistetuilla rotilla (Mohamed). Vasemman kammion hypertrofia kroonisesta hypertensiosta. TRPC-kanavat vahvistettu kammioiden lihassoluissa (arytmia-substraatti). CRY2-TRPC1 myoblasteissa (Iversen 2025).",
    keyRefs: ["mohamed-bp-emf"],
    level: "M",
    bermPathway: ["A"],
    bermBridgeEn: "BERM candidate after the conditional L2 operator: SA-node and ventricular channel biology motivate HRV and contractility endpoints; an endpoint-specific tissue response is not calibrated here.",
    bermBridgeFi: "BERM-ehdokas ehdollisen L2-operaattorin jälkeen: SA-solmun ja kammioiden kanavabiologia motivoi HRV- ja supistuvuusvastemuuttujia; päätepistekohtaista kudosvastetta ei kalibroida tässä.",
  ...
  },
  {
    ...
    level: "M|C",
    bermPathway: ["A", "D"],
    bermBridgeEn: "BERM candidate after the conditional L2 operator: pituitary and thyroid endpoints can be paired with calibrated local exposure measurements; the tissue kernel remains open and anatomy alone does not establish an effect.",
    bermBridgeFi: "BERM-ehdokas ehdollisen L2-operaattorin jälkeen: aivolisäkkeen ja kilpirauhasen päätepisteet voidaan yhdistää kalibroituihin paikallismittauksiin; kudosydin on avoin eikä anatomia yksin osoita vaikutusta.",
