...
export const SUBATLASES: SubAtlas[] = [
  ...
  { id: "physics", title: { en: "Physics & measurement", fi: "Fysiikka ja mittaus" }, description: { en: "BERM proposes routes from the 2025 premise and tensor derivation to physical inputs and receiver mechanisms. The L2 coupling remains open; measurement inference is shown separately.", fi: "BERM ehdottaa reittejä vuoden 2025 premissistä ja tensorijohdosta fysikaalisiin syötteisiin ja vastaanotinmekanismeihin. L2-kytkentä on avoin; mittauspäättely näkyy erikseen." }, stages: ["foundations", "sources", "measurement"], anchors: ["mod_geometry", "mod_ion", "mech_catsper_nav", "dkc_overlap", "mod_state_response_window", "mech_ipr_bound_ion", "mech_vgcc_ros", "mech_cry_melatonin"] },
  ...
  { id: "reproduction", title: { en: "Reproduction & demography", fi: "Lisääntyminen ja demografia" }, description: { en: "From reserves, timing and fertilization gates to couple distributions, waiting time, demand, tempo, ART, ASFR and TFR. Alternative aggregations are not additive pathways.", fi: "Reserveistä, ajoituksesta ja hedelmöittymisporteista parijakaumiin, odotusaikaan, kysyntään, tempoon, hoitoihin, ASFR:ään ja TFR:ään. Vaihtoehtoisia aggregointeja ei lasketa yhteen." }, stages: ["demographic"], anchors: ["berm_l2_bridge", "mech_vgcc_ros", "mech_cry_melatonin", "receptor_memory", "circadian_coordination", "hormone_target", "vmem_mtor", "developmental_memory", "hpa_hpg", "microbiome_oxytocin", "tissue_melatonin", "tissue_testosterone", "tissue_sperm", "tissue_ovarian", "tissue_btb", "barrier_placenta", "male_reserve", "male_steroidogenesis", "ovarian_reserve", "oocyte_redox", "ovulation_clock", "implantation", "tissue_organ_memory", "tissue_fertilization_gates", "disease_fertility", "mech_catsper_nav"] },
  { id: "society", title: { en: "Behaviour & society", fi: "Käyttäytyminen ja yhteiskunta" }, description: { en: "Hormone and neural state → behaviour distributions → pairing and collective action → institutions and environmental feedback. These are conditional syntheses, not calibrated field-to-politics predictions.", fi: "Hormoni- ja hermostotila → käyttäytymisjakaumat → parinmuodostus ja yhteistoiminta → instituutiot ja ympäristöpalaute. Nämä ovat ehdollisia synteesejä, eivät kalibroituja kentästä politiikkaan ulottuvia ennusteita." }, stages: ["civilization"], anchors: ["hpa_hpg", "hormone_target", "microbiome_oxytocin", "circadian_coordination", "tissue_testosterone", "tissue_cortisol", "disease_depression", "disease_metabolic", "demo_behavior", "demand_opportunity", "tempo", "demo_tfr", "legacy_proxy", "physical_state"] },
...
export const STEPPER_PATHS: Record<string, StepperPath> = {
  physics: { atlasId: "physics", label: { en: "Premise → open bridge", fi: "Premissi → avoin silta" }, ids: ["lindgren_2025", "metric_perturbation", "berm_l2_bridge", "mech_vgcc_ros"] },
