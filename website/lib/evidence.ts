...
export const FIELDSTATE_EVIDENCE: readonly FieldStateEvidenceRecord[] = [
  ...
  },
  {
    ...
    citation: "Ayas B & Kocaman A. Human Reproduction / ESHRE 2021 (abstract)",
    year: 2021,
    referenceId: "catsper_2021",
    studyType: "Controlled in-vivo rat experiment reported as a conference abstract",
    system: "50 male Wistar-Albino rats in five groups; 20 females for mating assessment",
    fieldClass: "2100 MHz RF, 1 hour/day for 28 days; amlodipine intervention and controls",
    finding: "The abstract reported lower epididymal sperm motility (47.62→34.19%) and intracellular Ca²⁺ (2.46→1.85), but no significant difference in mating score or live-birth rate. CatSper gene-expression analysis was pending.",
    causalNodes: ["A_VGCC_ROS", "MALE_SPERM"],
    directness: "REPRODUCTIVE_ENDPOINT",
    scope: "Rat sperm endpoints after repeated in-vivo exposure; not human gamete evidence, a selective CatSper intervention or an inferred earlier calcium pulse.",
    calibrationRole: "STRUCTURAL_ONLY",
    limitations: ["Conference abstract, not full peer-reviewed paper", "Rat experiment; no human gametes", "Single frequency tested", "Amlodipine is not CatSper-specific", "Non-significant live-birth result is not an equivalence demonstration"],
    isTfrCoefficient: false,
  },
  {
