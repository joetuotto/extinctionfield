...
export const BRIDGE_COMPONENTS = manifest.theory.bridgeComponents;
...
export const MODULOME_ASFR_ROUTE_ID = manifest.routes.modulomeAsfr.id;
export const DKC_CANDIDATE_ROUTE_ID = manifest.routes.lindgrenDkc.id;
