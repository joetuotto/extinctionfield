...
export const EVIDENCE_CARDS: EvidenceCard[] = [
  ...
  },
  {
    ...
    berm_relevance_fi: "Kvantifioi iiris-CRY-melatoniini-polun. Siniset silmät tuottavat 22 % voimakkaamman melatoniinin vaimentumisen — suora mittaus polku C:n vahvistuneesta aktivaatiosta.",
  ...
  },
  {
    ...
    berm_relevance_fi: "Kiinan B2-tapaus: Kiinassa on >90 % B2-puutos JA maailman alhaisin TFR. Tämä on ekologinen korrelaatio (ei kausaalinen todiste), mutta mekanismi on selvä: B2 → FAD → CRY-stabiilisuus → polku C:n toiminta. Jos B2-lisä Kiinassa parantaisi CRY-riippuvaisia sirkadiaanisia markkereita, se olisi vahvaa näyttöä ravitsemuksellisen modulaation hypoteesille. Tämä on ennuste NUT-2.",
...
export const PREDICTIONS: Prediction[] = [
  ...
  },
  {
    ...
    title_fi: "Silmien väri säätelee BERM:n polku C:n tehokkuutta populaatioiden välillä",
    ...
    test_fi: "Ekologinen: BERM:n 54 maan datasetissä testaa osoittavatko populaatiot joissa on korkeampi sinisten/vihreiden silmien esiintyvyys voimakkaampaa EMF-TFR-assosiaatiota BKT:n ja koulutuksen kontrolloinnin jälkeen. Jos polku C:tä säätelee silmien väri, Pohjois-Euroopan populaatioiden (korkea sinisilmäisyyden esiintyvyys) tulisi osoittaa suurempaa biologista EMF-herkkyyttä.",
